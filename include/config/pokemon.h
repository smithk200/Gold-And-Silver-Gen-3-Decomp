...
#define P_GBA_STYLE_SPECIES_GFX         0       /*The Silly Scope is an item that changes how the sprites look in-game. For people wanting to revert to the classic
way of looking at the graphics, all you need to do is toggle FLAG_SILLY_SCOPE.
*/
// By default, Pokémon sprites use Gen 4/5's style. The P_GBA_STYLE_SPECIES_GFX config can revert them back to GBA-style. NOTE: B_ENEMY_MON_SHADOW_STYLE is disabled when using these sprites for now.
