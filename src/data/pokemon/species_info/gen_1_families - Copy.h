...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Bulbasaur_gba : gMonFrontPic_Bulbasaur,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 40) : MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 14 : 13,
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Bulbasaur_gba : gMonBackPic_Bulbasaur,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 32) : MON_COORDS_SIZE(56, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 16 : 13,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Bulbasaur_gba : gMonPalette_Bulbasaur,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Bulbasaur_gba : gMonShinyPalette_Bulbasaur,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Bulbasaur_gba : gMonIcon_Bulbasaur,
    ...
    [SPECIES_IVYSAUR] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Ivysaur_gba : gMonFrontPic_Ivysaur,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 48) : MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 10 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 1),
            ANIMCMD_FRAME(1, 36),
            ANIMCMD_FRAME(0, 10),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Ivysaur_gba : gMonBackPic_Ivysaur,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Ivysaur_gba : gMonPalette_Ivysaur,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Ivysaur_gba : gMonShinyPalette_Ivysaur,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Ivysaur_gba : gMonIcon_Ivysaur,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 4,
    ...
    [SPECIES_VENUSAUR] =
    {
        ...
        .trainerScale = 388,
        .trainerOffset = 6,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Venusaur_gba : gMonFrontPic_Venusaur,
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Venusaur_gba : gMonBackPic_Venusaur,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 7 : 10,
        .backAnimId = BACK_ANIM_H_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Venusaur_gba : gMonPalette_Venusaur,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Venusaur_gba : gMonShinyPalette_Venusaur,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Venusaur_gba : gMonIcon_Venusaur,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 4,
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Charmander_gba : gMonFrontPic_Charmander,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 12 : 10,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 2),
            ANIMCMD_FRAME(1, 46),
            ANIMCMD_FRAME(0, 10),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Charmander_gba : gMonBackPic_Charmander,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(48, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 14 : 9,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Charmander_gba : gMonPalette_Charmander,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Charmander_gba : gMonShinyPalette_Charmander,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Charmander_gba : gMonIcon_Charmander,
        .iconPalIndex = 0,
    ...
    [SPECIES_CHARMELEON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Charmeleon_gba : gMonFrontPic_Charmeleon,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 9 : 8,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 25),
            ANIMCMD_FRAME(0, 30),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Charmeleon_gba : gMonBackPic_Charmeleon,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 8,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Charmeleon_gba : gMonPalette_Charmeleon,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Charmeleon_gba : gMonShinyPalette_Charmeleon,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Charmeleon_gba : gMonIcon_Charmeleon,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_CHARIZARD] =
    {
        ...
        .trainerScale = 302,
        .trainerOffset = 3,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Charizard_gba : gMonFrontPic_Charizard,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 1 : 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 20),
            ANIMCMD_FRAME(0, 10),
        ),
        .frontAnimId = ANIM_V_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Charizard_gba : gMonBackPic_Charizard,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 4 : 1,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Charizard_gba : gMonPalette_Charizard,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Charizard_gba : gMonShinyPalette_Charizard,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Charizard_gba : gMonIcon_Charizard,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SQUIRTLE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Squirtle_gba : gMonFrontPic_Squirtle,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(40, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 13 : 11,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 11),
            ANIMCMD_FRAME(0, 11),
            ANIMCMD_FRAME(1, 11),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_SWING_CONCAVE : ANIM_V_JUMPS_BIG,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Squirtle_gba : gMonBackPic_Squirtle,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(48, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 14 : 9,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Squirtle_gba : gMonPalette_Squirtle,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Squirtle_gba : gMonShinyPalette_Squirtle,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Squirtle_gba : gMonIcon_Squirtle,
        .iconPalIndex = 0,
    ...
    [SPECIES_WARTORTLE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Wartortle_gba : gMonFrontPic_Wartortle,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 8 : 7,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 20),
            ANIMCMD_FRAME(0, 5),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Wartortle_gba : gMonBackPic_Wartortle,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 7,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Wartortle_gba : gMonPalette_Wartortle,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Wartortle_gba : gMonShinyPalette_Wartortle,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Wartortle_gba : gMonIcon_Wartortle,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_BLASTOISE] =
    {
        ...
        .trainerScale = 293,
        .trainerOffset = 2,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Blastoise_gba : gMonFrontPic_Blastoise,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 0 : 4,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 20),
            ANIMCMD_FRAME(0, 20),
            ANIMCMD_FRAME(1, 25),
        ...
        .frontAnimDelay = FLAG_SILLY_SCOPE ? 50 : 20,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Blastoise_gba : gMonBackPic_Blastoise,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 7,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_BLUE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Blastoise_gba : gMonPalette_Blastoise,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Blastoise_gba : gMonShinyPalette_Blastoise,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Blastoise_gba : gMonIcon_Blastoise,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_CATERPIE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Caterpie_gba : gMonFrontPic_Caterpie,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 40) : MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 16 : 12,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 15),
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 15),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Caterpie_gba : gMonBackPic_Caterpie,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(48, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 15 : 12,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Caterpie_gba : gMonPalette_Caterpie,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Caterpie_gba : gMonShinyPalette_Caterpie,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Caterpie_gba : gMonIcon_Caterpie,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
    ...
    [SPECIES_METAPOD] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Metapod_gba : gMonFrontPic_Metapod,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 32) : MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 20 : 14,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 45),
            ANIMCMD_FRAME(0, 5),
        ),
        .frontAnimId = ANIM_SWING_CONCAVE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Metapod_gba : gMonBackPic_Metapod,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(40, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 12 : 8,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Metapod_gba : gMonPalette_Metapod,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Metapod_gba : gMonShinyPalette_Metapod,
    ...
    [SPECIES_BUTTERFREE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Butterfree_gba : gMonFrontPic_Butterfree,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 9 : 10,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 5),
            ANIMCMD_FRAME(1, 5),
            ANIMCMD_FRAME(0, 5),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_H_SLIDE_WOBBLE : ANIM_V_SLIDE_WOBBLE,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 8 : 12,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Butterfree_gba : gMonBackPic_Butterfree,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 6 : 5,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Butterfree_gba : gMonPalette_Butterfree,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Butterfree_gba : gMonShinyPalette_Butterfree,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Butterfree_gba : gMonIcon_Butterfree,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_WEEDLE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Weedle_gba : gMonFrontPic_Weedle,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 32) : MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 18 : 13,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 5),
            ANIMCMD_FRAME(1, 15),
            ANIMCMD_FRAME(0, 15),
        ...
        .frontAnimDelay = 10,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Weedle_gba : gMonBackPic_Weedle,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 48) : MON_COORDS_SIZE(56, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 7,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Weedle_gba : gMonPalette_Weedle,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Weedle_gba : gMonShinyPalette_Weedle,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Weedle_gba : gMonIcon_Weedle,
    ...
    [SPECIES_KAKUNA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Kakuna_gba : gMonFrontPic_Kakuna,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 40) : MON_COORDS_SIZE(24, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 14 : 11,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 5),
            ANIMCMD_FRAME(1, 5),
            ANIMCMD_FRAME(0, 5),
        ...
        .frontAnimDelay = 20,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Kakuna_gba : gMonBackPic_Kakuna,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 48) : MON_COORDS_SIZE(32, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 12,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Kakuna_gba : gMonPalette_Kakuna,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Kakuna_gba : gMonShinyPalette_Kakuna,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Kakuna_gba : gMonIcon_Kakuna,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
...
#define BEEDRILL_ATTACK (P_UPDATED_STATS >= GEN_6 ? 90 : 80)
    ...
    [SPECIES_BEEDRILL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Beedrill_gba : gMonFrontPic_Beedrill,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 48) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 9 : 5,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 5),
            ANIMCMD_FRAME(1, 35),
            ANIMCMD_FRAME(0, 15),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_H_VIBRATE : ANIM_ZIGZAG_SLOW,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 8 : 9,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Beedrill_gba : gMonBackPic_Beedrill,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 5,
        .backAnimId = BACK_ANIM_H_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Beedrill_gba : gMonPalette_Beedrill,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Beedrill_gba : gMonShinyPalette_Beedrill,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Beedrill_gba : gMonIcon_Beedrill,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_PIDGEY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Pidgey_gba : gMonFrontPic_Pidgey,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 13 : 12,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 5),
            ANIMCMD_FRAME(1, 25),
            ANIMCMD_FRAME(0, 5),
        ),
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_SLIDE_SLOW : ANIM_V_STRETCH,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 16 : 0,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Pidgey_gba : gMonBackPic_Pidgey,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 11,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Pidgey_gba : gMonPalette_Pidgey,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Pidgey_gba : gMonShinyPalette_Pidgey,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Pidgey_gba : gMonIcon_Pidgey,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-1, -1, SHADOW_SIZE_S)
        FOOTPRINT(Pidgey)
    ...
    [SPECIES_PIDGEOTTO] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Pidgeotto_gba : gMonFrontPic_Pidgeotto,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 11 : 6,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 5),
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = ANIM_V_STRETCH,
        .frontAnimDelay = 25,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Pidgeotto_gba : gMonBackPic_Pidgeotto,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 40) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 12 : 6,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Pidgeotto_gba : gMonPalette_Pidgeotto,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Pidgeotto_gba : gMonShinyPalette_Pidgeotto,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Pidgeotto_gba : gMonIcon_Pidgeotto,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_PIDGEOT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Pidgeot_gba : gMonFrontPic_Pidgeot,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 1 : 2,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 20),
            ANIMCMD_FRAME(0, 10),
        ),
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_FRONT_FLIP : ANIM_GROW_VIBRATE,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 4 : 5,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Pidgeot_gba : gMonBackPic_Pidgeot,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 64) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 2 : 7,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Pidgeot_gba : gMonPalette_Pidgeot,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Pidgeot_gba : gMonShinyPalette_Pidgeot,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Pidgeot_gba : gMonIcon_Pidgeot,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_RATTATA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Rattata_gba : gMonFrontPic_Rattata,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 32) : MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 16 : 13,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 11),
            ANIMCMD_FRAME(0, 11),
            ANIMCMD_FRAME(1, 11),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_RAPID_H_HOPS : ANIM_H_JUMPS,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Rattata_gba : gMonBackPic_Rattata,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 13 : 7,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Rattata_gba : gMonPalette_Rattata,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Rattata_gba : gMonShinyPalette_Rattata,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Rattata_gba : gMonIcon_Rattata,
        .iconPalIndex = 2,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_RATICATE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Raticate_gba : gMonFrontPic_Raticate,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 11 : 6,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 5),
            ANIMCMD_FRAME(0, 5),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_FIGURE_8 : ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Raticate_gba : gMonBackPic_Raticate,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 40) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 13 : 10,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Raticate_gba : gMonPalette_Raticate,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Raticate_gba : gMonShinyPalette_Raticate,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Raticate_gba : gMonIcon_Raticate,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 2,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_SPEAROW] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Spearow_gba : gMonFrontPic_Spearow,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 40) : MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 15 : 12,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 11),
            ANIMCMD_FRAME(0, 11),
            ANIMCMD_FRAME(1, 11),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_RISING_WOBBLE : ANIM_V_JUMPS_SMALL,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Spearow_gba : gMonBackPic_Spearow,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(56, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 12 : 6,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Spearow_gba : gMonPalette_Spearow,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Spearow_gba : gMonShinyPalette_Spearow,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Spearow_gba : gMonIcon_Spearow,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_FEAROW] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Fearow_gba : gMonFrontPic_Fearow,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 64) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 7),
            ANIMCMD_FRAME(0, 7),
        ...
        .frontAnimDelay = 2,
        .enemyMonElevation = 6,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Fearow_gba : gMonBackPic_Fearow,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 5 : 4,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Fearow_gba : gMonPalette_Fearow,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Fearow_gba : gMonShinyPalette_Fearow,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Fearow_gba : gMonIcon_Fearow,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_EKANS] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Ekans_gba : gMonFrontPic_Ekans,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 12 : 10,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 8),
            ANIMCMD_FRAME(0, 8),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_H_STRETCH : ANIM_V_STRETCH,
        .frontAnimDelay = 30,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Ekans_gba : gMonBackPic_Ekans,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 10,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Ekans_gba : gMonPalette_Ekans,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Ekans_gba : gMonShinyPalette_Ekans,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Ekans_gba : gMonIcon_Ekans,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_ARBOK] =
    {
        ...
        .trainerScale = 296,
        .trainerOffset = 2,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Arbok_gba : gMonFrontPic_Arbok,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 2 : 1,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 5),
            ANIMCMD_FRAME(1, 35),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Arbok_gba : gMonBackPic_Arbok,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 4 : 1,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Arbok_gba : gMonPalette_Arbok,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Arbok_gba : gMonShinyPalette_Arbok,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Arbok_gba : gMonIcon_Arbok,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_PICHU] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Pichu_gba : gMonFrontPic_Pichu,
        .frontPicSize = MON_COORDS_SIZE(32, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 12 : 14,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 20),
            ANIMCMD_FRAME(0, 15),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Pichu_gba : gMonBackPic_Pichu,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(48, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 8,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Pichu_gba : gMonPalette_Pichu,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Pichu_gba : gMonShinyPalette_Pichu,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Pichu_gba : gMonIcon_Pichu,
    ...
    [SPECIES_PIKACHU] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Pikachu_gba : gMonFrontPic_Pikachu,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 60),
        ...
        .frontAnimDelay = FLAG_SILLY_SCOPE ? 0 : 25,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Pikachu_gba : gMonBackPic_Pikachu,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 7 : 4,
        .backAnimId = BACK_ANIM_SHAKE_FLASH_YELLOW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Pikachu_gba : gMonPalette_Pikachu,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Pikachu_gba : gMonShinyPalette_Pikachu,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Pikachu_gba : gMonIcon_Pikachu,
        .iconPalIndex = 2,
#if P_GENDER_DIFFERENCES
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_RAICHU] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Raichu_gba : gMonFrontPic_Raichu,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 4 : 3,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 20),
            ANIMCMD_FRAME(0, 15),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_STRETCH : ANIM_GROW_VIBRATE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Raichu_gba : gMonBackPic_Raichu,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 6,
        .backAnimId = BACK_ANIM_SHAKE_FLASH_YELLOW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Raichu_gba : gMonPalette_Raichu,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Raichu_gba : gMonShinyPalette_Raichu,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Raichu_gba : gMonIcon_Raichu,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_SANDSHREW] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Sandshrew_gba : gMonFrontPic_Sandshrew,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 14 : 11,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Sandshrew_gba : gMonBackPic_Sandshrew,
        .backPicSize = MON_COORDS_SIZE(48, 40),
        .backPicYOffset = 13,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Sandshrew_gba : gMonPalette_Sandshrew,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Sandshrew_gba : gMonShinyPalette_Sandshrew,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Sandshrew_gba : gMonIcon_Sandshrew,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
    ...
    [SPECIES_SANDSLASH] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Sandslash_gba : gMonFrontPic_Sandslash,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 9 : 6,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_STRETCH : ANIM_H_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Sandslash_gba : gMonBackPic_Sandslash,
        .backPicSize = MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 11,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Sandslash_gba : gMonPalette_Sandslash,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Sandslash_gba : gMonShinyPalette_Sandslash,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Sandslash_gba : gMonIcon_Sandslash,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_NIDORAN_F] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_NidoranF_gba : gMonFrontPic_NidoranF,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 40) : MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 15 : 13,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 5),
            ANIMCMD_FRAME(1, 5),
            ANIMCMD_FRAME(0, 5),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .frontAnimDelay = 28,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_NidoranF_gba : gMonBackPic_NidoranF,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(48, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 12 : 13,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_NidoranF_gba : gMonPalette_NidoranF,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_NidoranF_gba : gMonShinyPalette_NidoranF,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_NidoranF_gba : gMonIcon_NidoranF,
    ...
    [SPECIES_NIDORINA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Nidorina_gba : gMonFrontPic_Nidorina,
        .frontPicSize = MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 11 : 8,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 40),
            ANIMCMD_FRAME(0, 10),
        ),
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Nidorina_gba : gMonBackPic_Nidorina,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 48) : MON_COORDS_SIZE(56, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 5,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Nidorina_gba : gMonPalette_Nidorina,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Nidorina_gba : gMonShinyPalette_Nidorina,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Nidorina_gba : gMonIcon_Nidorina,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(3, 5, SHADOW_SIZE_M)
        FOOTPRINT(Nidorina)
    ...
    [SPECIES_NIDOQUEEN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Nidoqueen_gba : gMonFrontPic_Nidoqueen,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 64) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 3 : 2,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 45),
            ANIMCMD_FRAME(0, 5),
        ),
        .frontAnimId = ANIM_H_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Nidoqueen_gba : gMonBackPic_Nidoqueen,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 6 : 5,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Nidoqueen_gba : gMonPalette_Nidoqueen,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Nidoqueen_gba : gMonShinyPalette_Nidoqueen,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Nidoqueen_gba : gMonIcon_Nidoqueen,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_NIDORAN_M] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_NidoranM_gba : gMonFrontPic_NidoranM,
        .frontPicSize = MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = 12,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_NidoranM_gba : gMonBackPic_NidoranM,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 48) : MON_COORDS_SIZE(48, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 9,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_NidoranM_gba : gMonPalette_NidoranM,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_NidoranM_gba : gMonShinyPalette_NidoranM,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_NidoranM_gba : gMonIcon_NidoranM,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
        SHADOW(1, 0, SHADOW_SIZE_S)
        FOOTPRINT(NidoranM)
    ...
    [SPECIES_NIDORINO] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Nidorino_gba : gMonFrontPic_Nidorino,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 9 : 8,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 7),
            ANIMCMD_FRAME(1, 23),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_SHRINK_GROW : ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Nidorino_gba : gMonBackPic_Nidorino,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 8,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Nidorino_gba : gMonPalette_Nidorino,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Nidorino_gba : gMonShinyPalette_Nidorino,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Nidorino_gba : gMonIcon_Nidorino,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_NIDOKING] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Nidoking_gba : gMonFrontPic_Nidoking,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 64) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 2,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
        ...
        .frontAnimId = ANIM_H_SHAKE,
        .frontAnimDelay = 25,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Nidoking_gba : gMonBackPic_Nidoking,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 3,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Nidoking_gba : gMonPalette_Nidoking,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Nidoking_gba : gMonShinyPalette_Nidoking,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Nidoking_gba : gMonIcon_Nidoking,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_CLEFFA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Cleffa_gba : gMonFrontPic_Cleffa,
        .frontPicSize = MON_COORDS_SIZE(32, 32),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 20 : 18,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 10),
        ...
        .frontAnimId = ANIM_V_JUMPS_SMALL,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Cleffa_gba : gMonBackPic_Cleffa,
        .backPicSize = MON_COORDS_SIZE(48, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 15 : 13,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Cleffa_gba : gMonPalette_Cleffa,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Cleffa_gba : gMonShinyPalette_Cleffa,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Cleffa_gba : gMonIcon_Cleffa,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
    ...
    [SPECIES_CLEFAIRY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Clefairy_gba : gMonFrontPic_Clefairy,
        .frontPicSize = MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 16 : 12,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Clefairy_gba : gMonBackPic_Clefairy,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(56, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 13 : 14,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Clefairy_gba : gMonPalette_Clefairy,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Clefairy_gba : gMonShinyPalette_Clefairy,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Clefairy_gba : gMonIcon_Clefairy,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
        SHADOW(1, 1, SHADOW_SIZE_S)
        FOOTPRINT(Clefairy)
    ...
    [SPECIES_CLEFABLE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Clefable_gba : gMonFrontPic_Clefable,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 8 : 6,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 16),
            ANIMCMD_FRAME(1, 48),
            ANIMCMD_FRAME(0, 5),
        ),
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL_SLOW : ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Clefable_gba : gMonBackPic_Clefable,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Clefable_gba : gMonPalette_Clefable,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Clefable_gba : gMonShinyPalette_Clefable,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Clefable_gba : gMonIcon_Clefable,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_VULPIX] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Vulpix_gba : gMonFrontPic_Vulpix,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 12 : 11,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 20),
            ANIMCMD_FRAME(0, 15),
        ...
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Vulpix_gba : gMonBackPic_Vulpix,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Vulpix_gba : gMonPalette_Vulpix,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Vulpix_gba : gMonShinyPalette_Vulpix,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Vulpix_gba : gMonIcon_Vulpix,
    ...
    [SPECIES_NINETALES] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Ninetales_gba : gMonFrontPic_Ninetales,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_SHAKE : ANIM_GROW_VIBRATE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Ninetales_gba : gMonBackPic_Ninetales,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 5,
        .backAnimId = BACK_ANIM_H_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Ninetales_gba : gMonPalette_Ninetales,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Ninetales_gba : gMonShinyPalette_Ninetales,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Ninetales_gba : gMonIcon_Ninetales,
    ...
    [SPECIES_IGGLYBUFF] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Igglybuff_gba : gMonFrontPic_Igglybuff,
        .frontPicSize = MON_COORDS_SIZE(32, 32),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 18 : 17,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 20),
            ANIMCMD_FRAME(0, 15),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Igglybuff_gba : gMonBackPic_Igglybuff,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(40, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 13,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Igglybuff_gba : gMonPalette_Igglybuff,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Igglybuff_gba : gMonShinyPalette_Igglybuff,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Igglybuff_gba : gMonIcon_Igglybuff,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
    ...
    [SPECIES_JIGGLYPUFF] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Jigglypuff_gba : gMonFrontPic_Jigglypuff,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 40) : MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 16 : 14,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 20),
            ANIMCMD_FRAME(0, 15),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Jigglypuff_gba : gMonBackPic_Jigglypuff,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(56, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 13 : 12,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Jigglypuff_gba : gMonPalette_Jigglypuff,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Jigglypuff_gba : gMonShinyPalette_Jigglypuff,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Jigglypuff_gba : gMonIcon_Jigglypuff,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
        SHADOW(-1, -1, SHADOW_SIZE_S)
...
#define WIGGLYTUFF_SP_ATK   50
    ...
    [SPECIES_WIGGLYTUFF] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Wigglytuff_gba : gMonFrontPic_Wigglytuff,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(48, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 8 : 4,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 20),
            ANIMCMD_FRAME(0, 15),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Wigglytuff_gba : gMonBackPic_Wigglytuff,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 0,
        .backAnimId = BACK_ANIM_GROW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Wigglytuff_gba : gMonPalette_Wigglytuff,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Wigglytuff_gba : gMonShinyPalette_Wigglytuff,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Wigglytuff_gba : gMonIcon_Wigglytuff,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_ZUBAT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Zubat_gba : gMonFrontPic_Zubat,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 6 : 16,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 3),
            ANIMCMD_FRAME(1, 3),
            ANIMCMD_FRAME(0, 3),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 8 : 16,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Zubat_gba : gMonBackPic_Zubat,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(56, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 7,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Zubat_gba : gMonPalette_Zubat,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Zubat_gba : gMonShinyPalette_Zubat,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Zubat_gba : gMonIcon_Zubat,
        .iconPalIndex = 2,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_GOLBAT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Golbat_gba : gMonFrontPic_Golbat,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 64) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 3 : 7,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 5),
            ANIMCMD_FRAME(1, 5),
            ANIMCMD_FRAME(0, 5),
        ...
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 8 : 10,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Golbat_gba : gMonBackPic_Golbat,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(56, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 6 : 13,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Golbat_gba : gMonPalette_Golbat,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Golbat_gba : gMonShinyPalette_Golbat,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Golbat_gba : gMonIcon_Golbat,
        .iconPalIndex = 2,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_CROBAT] =
    {
        ...
        .trainerScale = 281,
        .trainerOffset = 1,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Crobat_gba : gMonFrontPic_Crobat,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 64) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 0 : 6,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 2),
            ANIMCMD_FRAME(1, 2),
            ANIMCMD_FRAME(0, 2),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 6 : 9,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Crobat_gba : gMonBackPic_Crobat,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 5 : 1,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Crobat_gba : gMonPalette_Crobat,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Crobat_gba : gMonShinyPalette_Crobat,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Crobat_gba : gMonIcon_Crobat,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_ODDISH] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Oddish_gba : gMonFrontPic_Oddish,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 40) : MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 11),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_SQUISH_AND_BOUNCE : ANIM_V_JUMPS_H_JUMPS,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Oddish_gba : gMonBackPic_Oddish,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 48) : MON_COORDS_SIZE(48, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 10,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Oddish_gba : gMonPalette_Oddish,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Oddish_gba : gMonShinyPalette_Oddish,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Oddish_gba : gMonIcon_Oddish,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 4,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
        SHADOW(0, -2, SHADOW_SIZE_S)
        FOOTPRINT(Oddish)
    ...
    [SPECIES_GLOOM] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Gloom_gba : gMonFrontPic_Gloom,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 10 : 11,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 21),
            ANIMCMD_FRAME(1, 45),
            ANIMCMD_FRAME(1, 10),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Gloom_gba : gMonBackPic_Gloom,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 11,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Gloom_gba : gMonPalette_Gloom,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Gloom_gba : gMonShinyPalette_Gloom,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Gloom_gba : gMonIcon_Gloom,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_VILEPLUME] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Vileplume_gba : gMonFrontPic_Vileplume,
        .frontPicSize = MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 6 : 7,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 38),
            ANIMCMD_FRAME(0, 1),
        ),
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_BOUNCE_ROTATE_TO_SIDES_SLOW : ANIM_V_SQUISH_AND_BOUNCE_SLOW,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Vileplume_gba : gMonBackPic_Vileplume,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 7 : 6,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Vileplume_gba : gMonPalette_Vileplume,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Vileplume_gba : gMonShinyPalette_Vileplume,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Vileplume_gba : gMonIcon_Vileplume,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_BELLOSSOM] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Bellossom_gba : gMonFrontPic_Bellossom,
        .frontPicSize = MON_COORDS_SIZE(32, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 14 : 12,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 5),
            ANIMCMD_FRAME(0, 5),
            ANIMCMD_FRAME(1, 5),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_SWING_CONCAVE : ANIM_H_SLIDE_SLOW,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Bellossom_gba : gMonBackPic_Bellossom,
        .backPicSize = MON_COORDS_SIZE(48, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Bellossom_gba : gMonPalette_Bellossom,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Bellossom_gba : gMonShinyPalette_Bellossom,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Bellossom_gba : gMonIcon_Bellossom,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
        SHADOW(0, 0, SHADOW_SIZE_S)
        FOOTPRINT(Bellossom)
    ...
    [SPECIES_PARAS] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Paras_gba : gMonFrontPic_Paras,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(48, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 5),
            ANIMCMD_FRAME(0, 5),
        ...
        .frontAnimId = ANIM_H_SLIDE_SLOW,
        .frontAnimDelay = 10,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Paras_gba : gMonBackPic_Paras,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 24) : MON_COORDS_SIZE(64, 32),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 20 : 18,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Paras_gba : gMonPalette_Paras,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Paras_gba : gMonShinyPalette_Paras,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Paras_gba : gMonIcon_Paras,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
    ...
    [SPECIES_PARASECT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Parasect_gba : gMonFrontPic_Parasect,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 48) : MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 8 : 7,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = ANIM_H_SHAKE,
        .frontAnimDelay = 45,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Parasect_gba : gMonBackPic_Parasect,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 7 : 13,
        .backAnimId = BACK_ANIM_H_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Parasect_gba : gMonPalette_Parasect,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Parasect_gba : gMonShinyPalette_Parasect,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Parasect_gba : gMonIcon_Parasect,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_VENONAT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = -1,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Venonat_gba : gMonFrontPic_Venonat,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(40, 56),
        .frontPicYOffset = 8,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 5),
            ANIMCMD_FRAME(0, 5),
        ...
        .frontAnimId = ANIM_V_JUMPS_H_JUMPS,
        .frontAnimDelay = 20,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Venonat_gba : gMonBackPic_Venonat,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 6 : 5,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Venonat_gba : gMonPalette_Venonat,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Venonat_gba : gMonShinyPalette_Venonat,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Venonat_gba : gMonIcon_Venonat,
    ...
    [SPECIES_VENOMOTH] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 1,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Venomoth_gba : gMonFrontPic_Venomoth,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 64) : MON_COORDS_SIZE(64, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 2 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 4),
            ANIMCMD_FRAME(0, 4),
            ANIMCMD_FRAME(1, 4),
        ...
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 8 : 16,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Venomoth_gba : gMonBackPic_Venomoth,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 4,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Venomoth_gba : gMonPalette_Venomoth,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Venomoth_gba : gMonShinyPalette_Venomoth,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Venomoth_gba : gMonIcon_Venomoth,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_DIGLETT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Diglett_gba : gMonFrontPic_Diglett,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 32) : MON_COORDS_SIZE(32, 32),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 18 : 17,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 25),
            ANIMCMD_FRAME(1, 35),
        ...
        .frontAnimId = ANIM_V_SHAKE,
        .frontAnimDelay = 25,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Diglett_gba : gMonBackPic_Diglett,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 32) : MON_COORDS_SIZE(40, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 16 : 14,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Diglett_gba : gMonPalette_Diglett,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Diglett_gba : gMonShinyPalette_Diglett,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Diglett_gba : gMonIcon_Diglett,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        NO_SHADOW
        FOOTPRINT(Diglett)
    ...
    [SPECIES_DUGTRIO] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Dugtrio_gba : gMonFrontPic_Dugtrio,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 40) : MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 13 : 11,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 35),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimDelay = 35,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Dugtrio_gba : gMonBackPic_Dugtrio,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(48, 32),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 17,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Dugtrio_gba : gMonPalette_Dugtrio,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Dugtrio_gba : gMonShinyPalette_Dugtrio,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Dugtrio_gba : gMonIcon_Dugtrio,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        NO_SHADOW
        FOOTPRINT(Dugtrio)
    ...
    [SPECIES_MEOWTH] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Meowth_gba : gMonFrontPic_Meowth,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 12 : 10,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 8),
        ...
        .frontAnimId = ANIM_V_JUMPS_SMALL,
        .frontAnimDelay = 40,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Meowth_gba : gMonBackPic_Meowth,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(56, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 12 : 6,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Meowth_gba : gMonPalette_Meowth,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Meowth_gba : gMonShinyPalette_Meowth,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Meowth_gba : gMonIcon_Meowth,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
        SHADOW(0, 3, SHADOW_SIZE_S)
        FOOTPRINT(Meowth)
    ...
    [SPECIES_PERSIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Persian_gba : gMonFrontPic_Persian,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 7 : 4,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 50),
            ANIMCMD_FRAME(0, 20),
        ),
        .frontAnimId = ANIM_V_STRETCH,
        .frontAnimDelay = 20,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Persian_gba : gMonBackPic_Persian,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Persian_gba : gMonPalette_Persian,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Persian_gba : gMonShinyPalette_Persian,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Persian_gba : gMonIcon_Persian,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-2, 8, SHADOW_SIZE_XL_BATTLE_ONLY)
        FOOTPRINT(Persian)
    ...
    [SPECIES_PSYDUCK] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Psyduck_gba : gMonFrontPic_Psyduck,
        .frontPicSize = MON_COORDS_SIZE(40, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 9 : 11,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 20),
            ANIMCMD_FRAME(0, 15),
        ...
        .frontAnimId = ANIM_V_JUMPS_H_JUMPS,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Psyduck_gba : gMonBackPic_Psyduck,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(48, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 7 : 9,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Psyduck_gba : gMonPalette_Psyduck,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Psyduck_gba : gMonShinyPalette_Psyduck,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Psyduck_gba : gMonIcon_Psyduck,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
    ...
    [SPECIES_GOLDUCK] =
    {
        ...
        .trainerScale = 273,
        .trainerOffset = 1,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Golduck_gba : gMonFrontPic_Golduck,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 64) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 2 : 4,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 20),
            ANIMCMD_FRAME(0, 15),
        ...
        .frontAnimId = ANIM_H_SHAKE_SLOW,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Golduck_gba : gMonBackPic_Golduck,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 5 : 3,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Golduck_gba : gMonPalette_Golduck,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Golduck_gba : gMonShinyPalette_Golduck,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Golduck_gba : gMonIcon_Golduck,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_MANKEY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Mankey_gba : gMonFrontPic_Mankey,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 14 : 11,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 5),
        ...
        .frontAnimDelay = 20,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Mankey_gba : gMonBackPic_Mankey,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 8,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Mankey_gba : gMonPalette_Mankey,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Mankey_gba : gMonShinyPalette_Mankey,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Mankey_gba : gMonIcon_Mankey,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
    ...
    [SPECIES_PRIMEAPE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Primeape_gba : gMonFrontPic_Primeape,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 7 : 6,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 14),
            ANIMCMD_FRAME(1, 14),
            ANIMCMD_FRAME(0, 14),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL : ANIM_BOUNCE_ROTATE_TO_SIDES,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Primeape_gba : gMonBackPic_Primeape,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 7 : 10,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Primeape_gba : gMonPalette_Primeape,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Primeape_gba : gMonShinyPalette_Primeape,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Primeape_gba : gMonIcon_Primeape,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_GROWLITHE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Growlithe_gba : gMonFrontPic_Growlithe,
        .frontPicSize = MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 11 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 8),
            ANIMCMD_FRAME(0, 8),
            ANIMCMD_FRAME(1, 8),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_BACK_AND_LUNGE : ANIM_V_STRETCH,
        .frontAnimDelay = 30,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Growlithe_gba : gMonBackPic_Growlithe,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(48, 56),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Growlithe_gba : gMonPalette_Growlithe,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Growlithe_gba : gMonShinyPalette_Growlithe,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Growlithe_gba : gMonIcon_Growlithe,
    ...
    [SPECIES_ARCANINE] =
    {
        ...
        .trainerScale = 312,
        .trainerOffset = 4,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Arcanine_gba : gMonFrontPic_Arcanine,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 2,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 38),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_H_VIBRATE : ANIM_V_SHAKE,
        .frontAnimDelay = FLAG_SILLY_SCOPE ? 40 : 8,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Arcanine_gba : gMonBackPic_Arcanine,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 6 : 4,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Arcanine_gba : gMonPalette_Arcanine,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Arcanine_gba : gMonShinyPalette_Arcanine,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Arcanine_gba : gMonIcon_Arcanine,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 0 : 3,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_POLIWAG] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Poliwag_gba : gMonFrontPic_Poliwag,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 32) : MON_COORDS_SIZE(64, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 19 : 13,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 20),
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Poliwag_gba : gMonBackPic_Poliwag,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 32) : MON_COORDS_SIZE(48, 32),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 16 : 18,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Poliwag_gba : gMonPalette_Poliwag,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Poliwag_gba : gMonShinyPalette_Poliwag,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Poliwag_gba : gMonIcon_Poliwag,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
        SHADOW(-3, 0, SHADOW_SIZE_S)
        FOOTPRINT(Poliwag)
    ...
    [SPECIES_POLIWHIRL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Poliwhirl_gba : gMonFrontPic_Poliwhirl,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 10 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 25),
        ...
        .frontAnimId = ANIM_H_JUMPS_V_STRETCH,
        .frontAnimDelay = 5,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Poliwhirl_gba : gMonBackPic_Poliwhirl,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(64, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 12 : 13,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Poliwhirl_gba : gMonPalette_Poliwhirl,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Poliwhirl_gba : gMonShinyPalette_Poliwhirl,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Poliwhirl_gba : gMonIcon_Poliwhirl,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-1, 4, SHADOW_SIZE_M)
        FOOTPRINT(Poliwhirl)
    ...
    [SPECIES_POLIWRATH] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Poliwrath_gba : gMonFrontPic_Poliwrath,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 8 : 6,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 45),
        ...
        .frontAnimId = ANIM_V_SHAKE_TWICE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Poliwrath_gba : gMonBackPic_Poliwrath,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 7,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Poliwrath_gba : gMonPalette_Poliwrath,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Poliwrath_gba : gMonShinyPalette_Poliwrath,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Poliwrath_gba : gMonIcon_Poliwrath,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, 7, SHADOW_SIZE_L)
        FOOTPRINT(Poliwrath)
    ...
    [SPECIES_POLITOED] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Politoed_gba : gMonFrontPic_Politoed,
        .frontPicSize = MON_COORDS_SIZE(48, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 6 : 4,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 10),
        ...
        .frontAnimId = ANIM_H_JUMPS_V_STRETCH,
        .frontAnimDelay = 40,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Politoed_gba : gMonBackPic_Politoed,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 5,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Politoed_gba : gMonPalette_Politoed,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Politoed_gba : gMonShinyPalette_Politoed,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Politoed_gba : gMonIcon_Politoed,
        .iconPalIndex = 1,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_ABRA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Abra_gba : gMonFrontPic_Abra,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 11 : 10,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 7),
            ANIMCMD_FRAME(1, 21),
            ANIMCMD_FRAME(0, 13),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_H_JUMPS : ANIM_H_VIBRATE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Abra_gba : gMonBackPic_Abra,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 12,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Abra_gba : gMonPalette_Abra,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Abra_gba : gMonShinyPalette_Abra,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Abra_gba : gMonIcon_Abra,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_KADABRA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Kadabra_gba : gMonFrontPic_Kadabra,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = 5,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 12),
        ...
        .frontAnimId = ANIM_GROW_VIBRATE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Kadabra_gba : gMonBackPic_Kadabra,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Kadabra_gba : gMonPalette_Kadabra,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Kadabra_gba : gMonShinyPalette_Kadabra,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Kadabra_gba : gMonIcon_Kadabra,
        .iconPalIndex = 2,
#if P_GENDER_DIFFERENCES
...
#define ALAKAZAM_SP_DEF 135
    ...
    [SPECIES_ALAKAZAM] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Alakazam_gba : gMonFrontPic_Alakazam,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 4 : 2,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 9),
            ANIMCMD_FRAME(1, 54),
            ANIMCMD_FRAME(0, 15),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_STRETCH : ANIM_GROW_VIBRATE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Alakazam_gba : gMonBackPic_Alakazam,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 5 : 6,
        .backAnimId = BACK_ANIM_GROW_STUTTER,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Alakazam_gba : gMonPalette_Alakazam,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Alakazam_gba : gMonShinyPalette_Alakazam,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Alakazam_gba : gMonIcon_Alakazam,
        .iconPalIndex = 2,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_MACHOP] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Machop_gba : gMonFrontPic_Machop,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 48) : MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 11 : 8,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 6),
            ANIMCMD_FRAME(1, 15),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_SQUISH_AND_BOUNCE : ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Machop_gba : gMonBackPic_Machop,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(48, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 12 : 6,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Machop_gba : gMonPalette_Machop,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Machop_gba : gMonShinyPalette_Machop,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Machop_gba : gMonIcon_Machop,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, 3, SHADOW_SIZE_S)
        FOOTPRINT(Machop)
    ...
    [SPECIES_MACHOKE] =
    {
        ...
        .trainerScale = 257,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Machoke_gba : gMonFrontPic_Machoke,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 6 : 4,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 20),
        ...
        .frontAnimId = ANIM_V_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Machoke_gba : gMonBackPic_Machoke,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 8,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Machoke_gba : gMonPalette_Machoke,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Machoke_gba : gMonShinyPalette_Machoke,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Machoke_gba : gMonIcon_Machoke,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-1, 9, SHADOW_SIZE_M)
        FOOTPRINT(Machoke)
    ...
    [SPECIES_MACHAMP] =
    {
        ...
        .trainerScale = 269,
        .trainerOffset = -1,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Machamp_gba : gMonFrontPic_Machamp,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 1 : 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 11),
        ...
        .frontAnimId = ANIM_H_JUMPS,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Machamp_gba : gMonBackPic_Machamp,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 4 : 7,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Machamp_gba : gMonPalette_Machamp,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Machamp_gba : gMonShinyPalette_Machamp,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Machamp_gba : gMonIcon_Machamp,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_BELLSPROUT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Bellsprout_gba : gMonFrontPic_Bellsprout,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 15 : 12,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 5),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_STRETCH : ANIM_H_JUMPS,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Bellsprout_gba : gMonBackPic_Bellsprout,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(40, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 11,
        .backAnimId = BACK_ANIM_V_STRETCH,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Bellsprout_gba : gMonPalette_Bellsprout,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Bellsprout_gba : gMonShinyPalette_Bellsprout,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Bellsprout_gba : gMonIcon_Bellsprout,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
        SHADOW(-2, 3, SHADOW_SIZE_S)
    ...
    [SPECIES_WEEPINBELL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Weepinbell_gba : gMonFrontPic_Weepinbell,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = 11,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 5),
        ...
        .frontAnimDelay = 3,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Weepinbell_gba : gMonBackPic_Weepinbell,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 11,
        .backAnimId = BACK_ANIM_V_STRETCH,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Weepinbell_gba : gMonPalette_Weepinbell,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Weepinbell_gba : gMonShinyPalette_Weepinbell,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Weepinbell_gba : gMonIcon_Weepinbell,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_VICTREEBEL] =
    {
        ...
        .trainerScale = 312,
        .trainerOffset = 3,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Victreebel_gba : gMonFrontPic_Victreebel,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 5 : 6,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = ANIM_H_JUMPS_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Victreebel_gba : gMonBackPic_Victreebel,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 6,
        .backAnimId = BACK_ANIM_V_STRETCH,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Victreebel_gba : gMonPalette_Victreebel,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Victreebel_gba : gMonShinyPalette_Victreebel,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Victreebel_gba : gMonIcon_Victreebel,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_TENTACOOL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Tentacool_gba : gMonFrontPic_Tentacool,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 48) : MON_COORDS_SIZE(48, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 9 : 7,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 8),
            ANIMCMD_FRAME(1, 15),
            ANIMCMD_FRAME(0, 7),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Tentacool_gba : gMonBackPic_Tentacool,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 48) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 9,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Tentacool_gba : gMonPalette_Tentacool,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Tentacool_gba : gMonShinyPalette_Tentacool,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Tentacool_gba : gMonIcon_Tentacool,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(1, 6, SHADOW_SIZE_M)
        FOOTPRINT(Tentacool)
    ...
    [SPECIES_TENTACRUEL] =
    {
        ...
        .trainerScale = 312,
        .trainerOffset = 1,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Tentacruel_gba : gMonFrontPic_Tentacruel,
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_SQUISH_AND_BOUNCE : ANIM_V_SLIDE_WOBBLE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Tentacruel_gba : gMonBackPic_Tentacruel,
        .backPicSize = MON_COORDS_SIZE(64, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Tentacruel_gba : gMonPalette_Tentacruel,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Tentacruel_gba : gMonShinyPalette_Tentacruel,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Tentacruel_gba : gMonIcon_Tentacruel,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(2, 8, SHADOW_SIZE_XL_BATTLE_ONLY)
...
#define GOLEM_ATTACK (P_UPDATED_STATS >= GEN_6 ? 120 : 110)
    ...
    [SPECIES_GEODUDE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Geodude_gba : gMonFrontPic_Geodude,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 32) : MON_COORDS_SIZE(64, 32),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 18 : 19,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 36),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 16 : 10,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Geodude_gba : gMonBackPic_Geodude,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Geodude_gba : gMonPalette_Geodude,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Geodude_gba : gMonShinyPalette_Geodude,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Geodude_gba : gMonIcon_Geodude,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(1, 2, SHADOW_SIZE_M)
        FOOTPRINT(Geodude)
    ...
    [SPECIES_GRAVELER] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Graveler_gba : gMonFrontPic_Graveler,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 4 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 16),
            ANIMCMD_FRAME(1, 16),
            ANIMCMD_FRAME(0, 16),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL : ANIM_V_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Graveler_gba : gMonBackPic_Graveler,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 40) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 12 : 10,
        .backAnimId = BACK_ANIM_H_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Graveler_gba : gMonPalette_Graveler,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Graveler_gba : gMonShinyPalette_Graveler,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Graveler_gba : gMonIcon_Graveler,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_GOLEM] =
    {
        ...
        .trainerScale = 296,
        .trainerOffset = 2,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Golem_gba : gMonFrontPic_Golem,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 5 : 6,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 8),
        ...
        .frontAnimId = ANIM_ROTATE_UP_SLAM_DOWN,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Golem_gba : gMonBackPic_Golem,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 32) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 16 : 11,
        .backAnimId = BACK_ANIM_H_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Golem_gba : gMonPalette_Golem,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Golem_gba : gMonShinyPalette_Golem,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Golem_gba : gMonIcon_Golem,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_PONYTA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Ponyta_gba : gMonFrontPic_Ponyta,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 8 : 6,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 30),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_GLOW_ORANGE : ANIM_V_SHAKE,
        .frontAnimDelay = FLAG_SILLY_SCOPE ? 0 : 10,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Ponyta_gba : gMonBackPic_Ponyta,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 4,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Ponyta_gba : gMonPalette_Ponyta,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Ponyta_gba : gMonShinyPalette_Ponyta,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Ponyta_gba : gMonIcon_Ponyta,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 0 : 3,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_RAPIDASH] =
    {
        ...
        .trainerScale = 289,
        .trainerOffset = 1,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Rapidash_gba : gMonFrontPic_Rapidash,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 1 : 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_CIRCULAR_VIBRATE : ANIM_H_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Rapidash_gba : gMonBackPic_Rapidash,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 5 : 0,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Rapidash_gba : gMonPalette_Rapidash,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Rapidash_gba : gMonShinyPalette_Rapidash,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Rapidash_gba : gMonIcon_Rapidash,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 0 : 3,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SLOWPOKE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Slowpoke_gba : gMonFrontPic_Slowpoke,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 32),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 11 : 16,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 20),
            ANIMCMD_FRAME(1, 50),
            ANIMCMD_FRAME(0, 20),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Slowpoke_gba : gMonBackPic_Slowpoke,
        .backPicSize = MON_COORDS_SIZE(64, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 14 : 13,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Slowpoke_gba : gMonPalette_Slowpoke,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Slowpoke_gba : gMonShinyPalette_Slowpoke,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Slowpoke_gba : gMonIcon_Slowpoke,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SLOWBRO] =
    {
        ...
        .trainerScale = 296,
        .trainerOffset = 2,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Slowbro_gba : gMonFrontPic_Slowbro,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 48) : MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 8 : 4,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 45),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_SWING_CONCAVE : ANIM_H_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Slowbro_gba : gMonBackPic_Slowbro,
        .backPicSize = MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 9,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Slowbro_gba : gMonPalette_Slowbro,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Slowbro_gba : gMonShinyPalette_Slowbro,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Slowbro_gba : gMonIcon_Slowbro,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SLOWKING] =
    {
        ...
        .trainerScale = 309,
        .trainerOffset = 5,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Slowking_gba : gMonFrontPic_Slowking,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 64) : MON_COORDS_SIZE(48, 64),
        .frontPicYOffset = 1,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 20),
        ...
        .frontAnimId = ANIM_SHRINK_GROW,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Slowking_gba : gMonBackPic_Slowking,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 3,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Slowking_gba : gMonPalette_Slowking,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Slowking_gba : gMonShinyPalette_Slowking,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Slowking_gba : gMonIcon_Slowking,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-2, 11, SHADOW_SIZE_M)
        FOOTPRINT(Slowking)
    ...
    [SPECIES_MAGNEMITE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Magnemite_gba : gMonFrontPic_Magnemite,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 24) : MON_COORDS_SIZE(48, 32),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 21 : 20,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 28),
            ANIMCMD_FRAME(1, 28),
            ANIMCMD_FRAME(0, 28),
        ...
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 16 : 17,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Magnemite_gba : gMonBackPic_Magnemite,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 24) : MON_COORDS_SIZE(48, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 20 : 15,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Magnemite_gba : gMonPalette_Magnemite,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Magnemite_gba : gMonShinyPalette_Magnemite,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Magnemite_gba : gMonIcon_Magnemite,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_MAGNETON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Magneton_gba : gMonFrontPic_Magneton,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 8 : 7,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 14),
        ...
        .frontAnimId = ANIM_FLASH_YELLOW,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 8 : 9,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Magneton_gba : gMonBackPic_Magneton,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 6,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Magneton_gba : gMonPalette_Magneton,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Magneton_gba : gMonShinyPalette_Magneton,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Magneton_gba : gMonIcon_Magneton,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 90 : 65)
    ...
    [SPECIES_FARFETCHD] =
    {
        ...
        .trainerScale = 293,
        .trainerOffset = 2,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Farfetchd_gba : gMonFrontPic_Farfetchd,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(48, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 9 : 7,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 5),
            ANIMCMD_FRAME(0, 5),
        ...
        .frontAnimId = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Farfetchd_gba : gMonBackPic_Farfetchd,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 9,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Farfetchd_gba : gMonPalette_Farfetchd,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Farfetchd_gba : gMonShinyPalette_Farfetchd,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Farfetchd_gba : gMonIcon_Farfetchd,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-3, 5, SHADOW_SIZE_M)
        FOOTPRINT(Farfetchd)
    ...
    [SPECIES_DODUO] =
    {
        ...
        .trainerScale = 257,
        .trainerOffset = -1,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Doduo_gba : gMonFrontPic_Doduo,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 56) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 5 : 7,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 18),
            ANIMCMD_FRAME(1, 18),
            ANIMCMD_FRAME(0, 18),
        ...
        .frontAnimId = ANIM_H_SHAKE_SLOW,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Doduo_gba : gMonBackPic_Doduo,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 6,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Doduo_gba : gMonPalette_Doduo,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Doduo_gba : gMonShinyPalette_Doduo,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Doduo_gba : gMonIcon_Doduo,
        .iconPalIndex = 2,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_DODRIO] =
    {
        ...
        .trainerScale = 268,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Dodrio_gba : gMonFrontPic_Dodrio,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 12),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_LUNGE_GROW : ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Dodrio_gba : gMonBackPic_Dodrio,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 1 : 3,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Dodrio_gba : gMonPalette_Dodrio,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Dodrio_gba : gMonShinyPalette_Dodrio,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Dodrio_gba : gMonIcon_Dodrio,
        .iconPalIndex = 2,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_SEEL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Seel_gba : gMonFrontPic_Seel,
        .frontPicSize = MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 10 : 8,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 30),
            ANIMCMD_FRAME(0, 20),
            ANIMCMD_FRAME(1, 30),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_SWING_CONCAVE : ANIM_H_SLIDE_SLOW,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Seel_gba : gMonBackPic_Seel,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 13,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Seel_gba : gMonPalette_Seel,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Seel_gba : gMonShinyPalette_Seel,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Seel_gba : gMonIcon_Seel,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_DEWGONG] =
    {
        ...
        .trainerScale = 275,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Dewgong_gba : gMonFrontPic_Dewgong,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 7 : 2,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 30),
            ANIMCMD_FRAME(1, 30),
            ANIMCMD_FRAME(0, 30),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Dewgong_gba : gMonBackPic_Dewgong,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 5,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Dewgong_gba : gMonPalette_Dewgong,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Dewgong_gba : gMonShinyPalette_Dewgong,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Dewgong_gba : gMonIcon_Dewgong,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_GRIMER] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Grimer_gba : gMonFrontPic_Grimer,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 12 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = ANIM_H_SLIDE_SLOW,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Grimer_gba : gMonBackPic_Grimer,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 40) : MON_COORDS_SIZE(64, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 12 : 13,
        .backAnimId = BACK_ANIM_V_STRETCH,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Grimer_gba : gMonPalette_Grimer,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Grimer_gba : gMonShinyPalette_Grimer,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Grimer_gba : gMonIcon_Grimer,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(2, 3, SHADOW_SIZE_M)
        FOOTPRINT(Grimer)
    ...
    [SPECIES_MUK] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Muk_gba : gMonFrontPic_Muk,
        .frontPicSize = MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 4 : 7,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimDelay = 45,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Muk_gba : gMonBackPic_Muk,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 5 : 9,
        .backAnimId = BACK_ANIM_H_STRETCH,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Muk_gba : gMonPalette_Muk,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Muk_gba : gMonShinyPalette_Muk,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Muk_gba : gMonIcon_Muk,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SHELLDER] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Shellder_gba : gMonFrontPic_Shellder,
        .frontPicSize = MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 16 : 13,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 5),
        ...
        .frontAnimDelay = 20,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Shellder_gba : gMonBackPic_Shellder,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(48, 24),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 21,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Shellder_gba : gMonPalette_Shellder,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Shellder_gba : gMonShinyPalette_Shellder,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Shellder_gba : gMonIcon_Shellder,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
        SHADOW(0, -4, SHADOW_SIZE_S)
        FOOTPRINT(Shellder)
    ...
    [SPECIES_CLOYSTER] =
    {
        ...
        .trainerScale = 269,
        .trainerOffset = 1,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Cloyster_gba : gMonFrontPic_Cloyster,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 5 : 3,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 32),
            ANIMCMD_FRAME(0, 14),
            ANIMCMD_FRAME(1, 18),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_H_SLIDE_WOBBLE : ANIM_V_SHAKE_TWICE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Cloyster_gba : gMonBackPic_Cloyster,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 6 : 7,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Cloyster_gba : gMonPalette_Cloyster,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Cloyster_gba : gMonShinyPalette_Cloyster,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Cloyster_gba : gMonIcon_Cloyster,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_GASTLY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Gastly_gba : gMonFrontPic_Gastly,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 6 : 13,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 18),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_GLOW_BLACK : ANIM_SHRINK_GROW,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 4 : 13,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Gastly_gba : gMonBackPic_Gastly,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 40) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 14 : 6,
        .backAnimId = BACK_ANIM_H_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Gastly_gba : gMonPalette_Gastly,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Gastly_gba : gMonShinyPalette_Gastly,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Gastly_gba : gMonIcon_Gastly,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_HAUNTER] =
    {
        ...
        .trainerScale = 293,
        .trainerOffset = 2,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Haunter_gba : gMonFrontPic_Haunter,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 5 : 13,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 8),
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 35),
        ...
        .frontAnimDelay = 23,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 4 : 14,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Haunter_gba : gMonBackPic_Haunter,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 4,
        .backAnimId = BACK_ANIM_H_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Haunter_gba : gMonPalette_Haunter,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Haunter_gba : gMonShinyPalette_Haunter,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Haunter_gba : gMonIcon_Haunter,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_GENGAR] =
    {
        ...
        .trainerScale = 302,
        .trainerOffset = 2,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Gengar_gba : gMonFrontPic_Gengar,
        .frontPicSize = MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 5 : 7,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 50),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Gengar_gba : gMonBackPic_Gengar,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 8,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Gengar_gba : gMonPalette_Gengar,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Gengar_gba : gMonShinyPalette_Gengar,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Gengar_gba : gMonIcon_Gengar,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_ONIX] =
    {
        ...
        .trainerScale = 515,
        .trainerOffset = 14,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Onix_gba : gMonFrontPic_Onix,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 64) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 2 : 3,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 50),
            ANIMCMD_FRAME(0, 30),
        ),
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_RAPID_H_HOPS : ANIM_H_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Onix_gba : gMonBackPic_Onix,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 64) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Onix_gba : gMonPalette_Onix,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Onix_gba : gMonShinyPalette_Onix,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Onix_gba : gMonIcon_Onix,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_STEELIX] =
    {
        ...
        .trainerScale = 516,
        .trainerOffset = 13,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Steelix_gba : gMonFrontPic_Steelix,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 7),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_H_SHAKE : ANIM_V_SHAKE,
        .frontAnimDelay = 45,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Steelix_gba : gMonBackPic_Steelix,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 0 : 2,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Steelix_gba : gMonPalette_Steelix,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Steelix_gba : gMonShinyPalette_Steelix,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Steelix_gba : gMonIcon_Steelix,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_DROWZEE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Drowzee_gba : gMonFrontPic_Drowzee,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(48, 56),
        .frontPicYOffset = 7,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 12),
            ANIMCMD_FRAME(0, 12),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_CIRCLE_C_CLOCKWISE_SLOW : ANIM_V_STRETCH,
        .frontAnimDelay = 48,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Drowzee_gba : gMonBackPic_Drowzee,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(56, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 13 : 9,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Drowzee_gba : gMonPalette_Drowzee,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Drowzee_gba : gMonShinyPalette_Drowzee,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Drowzee_gba : gMonIcon_Drowzee,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(1, 6, SHADOW_SIZE_M)
        FOOTPRINT(Drowzee)
    ...
    [SPECIES_HYPNO] =
    {
        ...
        .trainerScale = 257,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Hypno_gba : gMonFrontPic_Hypno,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 4 : 3,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 15),
        ...
        .frontAnimId = ANIM_GROW_VIBRATE,
        .frontAnimDelay = 40,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Hypno_gba : gMonBackPic_Hypno,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 5,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Hypno_gba : gMonPalette_Hypno,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Hypno_gba : gMonShinyPalette_Hypno,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Hypno_gba : gMonIcon_Hypno,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 2,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_KRABBY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Krabby_gba : gMonFrontPic_Krabby,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(64, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 13 : 14,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 16),
            ANIMCMD_FRAME(0, 16),
            ANIMCMD_FRAME(1, 16),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_H_SLIDE : ANIM_H_SLIDE_SLOW,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Krabby_gba : gMonBackPic_Krabby,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 15,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Krabby_gba : gMonPalette_Krabby,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Krabby_gba : gMonShinyPalette_Krabby,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Krabby_gba : gMonIcon_Krabby,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
    ...
    [SPECIES_KINGLER] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Kingler_gba : gMonFrontPic_Kingler,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 64) : MON_COORDS_SIZE(64, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 3 : 8,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 50),
            ANIMCMD_FRAME(0, 14),
        ),
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_ZIGZAG_SLOW : ANIM_V_SHAKE_TWICE,
        .frontAnimDelay = FLAG_SILLY_SCOPE ? 0 : 4,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Kingler_gba : gMonBackPic_Kingler,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 4 : 5,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Kingler_gba : gMonPalette_Kingler,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Kingler_gba : gMonShinyPalette_Kingler,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Kingler_gba : gMonIcon_Kingler,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-2, 4, SHADOW_SIZE_XL_BATTLE_ONLY)
        FOOTPRINT(Kingler)
    ...
    [SPECIES_VOLTORB] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Voltorb_gba : gMonFrontPic_Voltorb,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 32) : MON_COORDS_SIZE(32, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 19 : 15,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 4),
            ANIMCMD_FRAME(1, 25),
            ANIMCMD_FRAME(0, 4),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_SQUISH_AND_BOUNCE : ANIM_SWING_CONCAVE,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 10 : 0,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Voltorb_gba : gMonBackPic_Voltorb,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(48, 40),
        .backPicYOffset = 14,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Voltorb_gba : gMonPalette_Voltorb,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Voltorb_gba : gMonShinyPalette_Voltorb,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Voltorb_gba : gMonIcon_Voltorb,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, -2, SHADOW_SIZE_S)
        FOOTPRINT(Voltorb)
    ...
    [SPECIES_ELECTRODE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Electrode_gba : gMonFrontPic_Electrode,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 14 : 11,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 14),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_SQUISH_AND_BOUNCE : ANIM_SHRINK_GROW_VIBRATE_SLOW,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 12 : 0,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Electrode_gba : gMonBackPic_Electrode,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(64, 40),
        .backPicYOffset = 13,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Electrode_gba : gMonPalette_Electrode,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Electrode_gba : gMonShinyPalette_Electrode,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Electrode_gba : gMonIcon_Electrode,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(1, 2, SHADOW_SIZE_M)
        FOOTPRINT(Electrode)
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Exeggcute_gba : gMonFrontPic_Exeggcute,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(56, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 7 : 12,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = ANIM_H_SLIDE_SLOW,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Exeggcute_gba : gMonBackPic_Exeggcute,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(64, 32),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 13 : 18,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Exeggcute_gba : gMonPalette_Exeggcute,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Exeggcute_gba : gMonShinyPalette_Exeggcute,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Exeggcute_gba : gMonIcon_Exeggcute,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
    ...
    [SPECIES_EXEGGUTOR] =
    {
        ...
        .trainerScale = 309,
        .trainerOffset = 5,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Exeggutor_gba : gMonFrontPic_Exeggutor,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 35),
        ...
        .frontAnimId = ANIM_H_JUMPS_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Exeggutor_gba : gMonBackPic_Exeggutor,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 4 : 8,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Exeggutor_gba : gMonPalette_Exeggutor,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Exeggutor_gba : gMonShinyPalette_Exeggutor,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Exeggutor_gba : gMonIcon_Exeggutor,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(2, 13, SHADOW_SIZE_L)
        FOOTPRINT(Exeggutor)
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Cubone_gba : gMonFrontPic_Cubone,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(56, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 15 : 13,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 6),
            ANIMCMD_FRAME(0, 6),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL : ANIM_V_SQUISH_AND_BOUNCE,
        .frontAnimDelay = FLAG_SILLY_SCOPE ? 0 : 30,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Cubone_gba : gMonBackPic_Cubone,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Cubone_gba : gMonPalette_Cubone,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Cubone_gba : gMonShinyPalette_Cubone,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Cubone_gba : gMonIcon_Cubone,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
        SHADOW(1, 0, SHADOW_SIZE_S)
        FOOTPRINT(Cubone)
    ...
    [SPECIES_MAROWAK] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Marowak_gba : gMonFrontPic_Marowak,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(56, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 11 : 8,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 14),
            ANIMCMD_FRAME(0, 14),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Marowak_gba : gMonBackPic_Marowak,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(48, 56),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Marowak_gba : gMonPalette_Marowak,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Marowak_gba : gMonShinyPalette_Marowak,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Marowak_gba : gMonIcon_Marowak,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_TYROGUE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Tyrogue_gba : gMonFrontPic_Tyrogue,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 48) : MON_COORDS_SIZE(40, 48),
        .frontPicYOffset = 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 40),
            ANIMCMD_FRAME(0, 20),
        ),
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_H_STRETCH : ANIM_BACK_AND_LUNGE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Tyrogue_gba : gMonBackPic_Tyrogue,
        .backPicSize = MON_COORDS_SIZE(48, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 10,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Tyrogue_gba : gMonPalette_Tyrogue,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Tyrogue_gba : gMonShinyPalette_Tyrogue,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Tyrogue_gba : gMonIcon_Tyrogue,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
        SHADOW(0, 4, SHADOW_SIZE_S)
        FOOTPRINT(Tyrogue)
    ...
    [SPECIES_HITMONLEE] =
    {
        ...
        .trainerScale = 259,
        .trainerOffset = 1,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Hitmonlee_gba : gMonFrontPic_Hitmonlee,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 4 : 5,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 16),
            ANIMCMD_FRAME(1, 18),
            ANIMCMD_FRAME(0, 1),
        ),
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_H_STRETCH : ANIM_H_JUMPS_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Hitmonlee_gba : gMonBackPic_Hitmonlee,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 12 : 4,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Hitmonlee_gba : gMonPalette_Hitmonlee,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Hitmonlee_gba : gMonShinyPalette_Hitmonlee,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Hitmonlee_gba : gMonIcon_Hitmonlee,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_HITMONCHAN] =
    {
        ...
        .trainerScale = 277,
        .trainerOffset = 2,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Hitmonchan_gba : gMonFrontPic_Hitmonchan,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(48, 64),
        .frontPicYOffset = 4,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 17),
        ...
        .frontAnimId = ANIM_GROW_VIBRATE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Hitmonchan_gba : gMonBackPic_Hitmonchan,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(56, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 12 : 6,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Hitmonchan_gba : gMonPalette_Hitmonchan,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Hitmonchan_gba : gMonShinyPalette_Hitmonchan,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Hitmonchan_gba : gMonIcon_Hitmonchan,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(1, 9, SHADOW_SIZE_M)
    ...
    [SPECIES_HITMONTOP] =
    {
        ...
        .trainerScale = 257,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Hitmontop_gba : gMonFrontPic_Hitmontop,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 5 : 7,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 12),
            ANIMCMD_FRAME(1, 26),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_H_VIBRATE : ANIM_SWING_CONCAVE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Hitmontop_gba : gMonBackPic_Hitmontop,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 5 : 6,
        .backAnimId = BACK_ANIM_CIRCLE_COUNTERCLOCKWISE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Hitmontop_gba : gMonPalette_Hitmontop,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Hitmontop_gba : gMonShinyPalette_Hitmontop,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Hitmontop_gba : gMonIcon_Hitmontop,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(1, 7, SHADOW_SIZE_L)
        FOOTPRINT(Hitmontop)
    ...
    [SPECIES_LICKITUNG] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Lickitung_gba : gMonFrontPic_Lickitung,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 48) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 8 : 7,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 16),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_SQUISH_AND_BOUNCE_SLOW : ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Lickitung_gba : gMonBackPic_Lickitung,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(64, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 14 : 13,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Lickitung_gba : gMonPalette_Lickitung,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Lickitung_gba : gMonShinyPalette_Lickitung,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Lickitung_gba : gMonIcon_Lickitung,
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Koffing_gba : gMonFrontPic_Koffing,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 8 : 10,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_SHRINK_GROW : ANIM_V_SLIDE_WOBBLE_SMALL,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 8 : 14,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Koffing_gba : gMonBackPic_Koffing,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 3,
        .backAnimId = BACK_ANIM_GROW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Koffing_gba : gMonPalette_Koffing,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Koffing_gba : gMonShinyPalette_Koffing,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Koffing_gba : gMonIcon_Koffing,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_WEEZING] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Weezing_gba : gMonFrontPic_Weezing,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 2 : 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
        ...
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 6 : 3,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Weezing_gba : gMonBackPic_Weezing,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 6 : 9,
        .backAnimId = BACK_ANIM_GROW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Weezing_gba : gMonPalette_Weezing,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Weezing_gba : gMonShinyPalette_Weezing,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Weezing_gba : gMonIcon_Weezing,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_RHYHORN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Rhyhorn_gba : gMonFrontPic_Rhyhorn,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(56, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 9 : 12,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 11),
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = ANIM_V_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Rhyhorn_gba : gMonBackPic_Rhyhorn,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 40) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 12 : 11,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Rhyhorn_gba : gMonPalette_Rhyhorn,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Rhyhorn_gba : gMonShinyPalette_Rhyhorn,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Rhyhorn_gba : gMonIcon_Rhyhorn,
        .iconPalIndex = 1,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_RHYDON] =
    {
        ...
        .trainerScale = 299,
        .trainerOffset = 2,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Rhydon_gba : gMonFrontPic_Rhydon,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 64) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 2 : 3,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 16),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_SHRINK_GROW : ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Rhydon_gba : gMonBackPic_Rhydon,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 64) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 3 : 5,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Rhydon_gba : gMonPalette_Rhydon,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Rhydon_gba : gMonShinyPalette_Rhydon,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Rhydon_gba : gMonIcon_Rhydon,
        .iconPalIndex = 1,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_CHANSEY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Chansey_gba : gMonFrontPic_Chansey,
        .frontPicSize = MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 30),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_SQUISH_AND_BOUNCE_SLOW : ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Chansey_gba : gMonBackPic_Chansey,
        .backPicSize = MON_COORDS_SIZE(64, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Chansey_gba : gMonPalette_Chansey,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Chansey_gba : gMonShinyPalette_Chansey,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Chansey_gba : gMonIcon_Chansey,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_BLISSEY] =
    {
        ...
        .trainerScale = 310,
        .trainerOffset = 3,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Blissey_gba : gMonFrontPic_Blissey,
        .frontPicSize = MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 6 : 5,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 30),
            ANIMCMD_FRAME(1, 30),
            ANIMCMD_FRAME(0, 30),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Blissey_gba : gMonBackPic_Blissey,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 40) : MON_COORDS_SIZE(64, 32),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 13 : 16,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Blissey_gba : gMonPalette_Blissey,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Blissey_gba : gMonShinyPalette_Blissey,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Blissey_gba : gMonIcon_Blissey,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(1, 8, SHADOW_SIZE_L)
        FOOTPRINT(Blissey)
    ...
    [SPECIES_TANGELA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Tangela_gba : gMonFrontPic_Tangela,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(48, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 7 : 12,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 40),
            ANIMCMD_FRAME(1, 24),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL : ANIM_H_JUMPS_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Tangela_gba : gMonBackPic_Tangela,
        .backPicSize = MON_COORDS_SIZE(64, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 14 : 12,
        .backAnimId = BACK_ANIM_V_STRETCH,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Tangela_gba : gMonPalette_Tangela,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Tangela_gba : gMonShinyPalette_Tangela,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Tangela_gba : gMonIcon_Tangela,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-1, 1, SHADOW_SIZE_M)
        FOOTPRINT(Tangela)
    ...
    [SPECIES_KANGASKHAN] =
    {
        ...
        .trainerScale = 387,
        .trainerOffset = 8,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Kangaskhan_gba : gMonFrontPic_Kangaskhan,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 0 : 1,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 20),
        ...
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Kangaskhan_gba : gMonBackPic_Kangaskhan,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 5 : 6,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Kangaskhan_gba : gMonPalette_Kangaskhan,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Kangaskhan_gba : gMonShinyPalette_Kangaskhan,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Kangaskhan_gba : gMonIcon_Kangaskhan,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_HORSEA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Horsea_gba : gMonFrontPic_Horsea,
        .frontPicSize = MON_COORDS_SIZE(32, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 15 : 14,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 11),
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_TWIST : ANIM_V_JUMPS_SMALL,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Horsea_gba : gMonBackPic_Horsea,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(48, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 14,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Horsea_gba : gMonPalette_Horsea,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Horsea_gba : gMonShinyPalette_Horsea,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Horsea_gba : gMonIcon_Horsea,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, 0, SHADOW_SIZE_S)
        FOOTPRINT(Horsea)
    ...
    [SPECIES_SEADRA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Seadra_gba : gMonFrontPic_Seadra,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 7 : 6,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 11),
        ...
        .frontAnimId = ANIM_V_SLIDE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Seadra_gba : gMonBackPic_Seadra,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 6,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Seadra_gba : gMonPalette_Seadra,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Seadra_gba : gMonShinyPalette_Seadra,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Seadra_gba : gMonIcon_Seadra,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_KINGDRA] =
    {
        ...
        .trainerScale = 287,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Kingdra_gba : gMonFrontPic_Kingdra,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 64) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 4 : 1,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 11),
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Kingdra_gba : gMonBackPic_Kingdra,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 6 : 7,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_BLUE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Kingdra_gba : gMonPalette_Kingdra,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Kingdra_gba : gMonShinyPalette_Kingdra,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Kingdra_gba : gMonIcon_Kingdra,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_GOLDEEN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Goldeen_gba : gMonFrontPic_Goldeen,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 10 : 13,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 16),
            ANIMCMD_FRAME(1, 16),
            ANIMCMD_FRAME(0, 16),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_SWING_CONVEX : ANIM_H_SLIDE_WOBBLE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Goldeen_gba : gMonBackPic_Goldeen,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 9,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Goldeen_gba : gMonPalette_Goldeen,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Goldeen_gba : gMonShinyPalette_Goldeen,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Goldeen_gba : gMonIcon_Goldeen,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_SEAKING] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Seaking_gba : gMonFrontPic_Seaking,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 4 : 5,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Seaking_gba : gMonBackPic_Seaking,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 6,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Seaking_gba : gMonPalette_Seaking,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Seaking_gba : gMonShinyPalette_Seaking,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Seaking_gba : gMonIcon_Seaking,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_STARYU] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Staryu_gba : gMonFrontPic_Staryu,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(40, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 10 : 11,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 11),
            ANIMCMD_FRAME(1, 10),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Staryu_gba : gMonBackPic_Staryu,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(56, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 13 : 6,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Staryu_gba : gMonPalette_Staryu,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Staryu_gba : gMonShinyPalette_Staryu,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Staryu_gba : gMonIcon_Staryu,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-1, 2, SHADOW_SIZE_M)
        FOOTPRINT(Staryu)
    ...
    [SPECIES_STARMIE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Starmie_gba : gMonFrontPic_Starmie,
        .frontPicSize = MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = 6,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 11),
        ...
        .frontAnimId = ANIM_TWIST,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Starmie_gba : gMonBackPic_Starmie,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 40) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 14 : 4,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_BLUE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Starmie_gba : gMonPalette_Starmie,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Starmie_gba : gMonShinyPalette_Starmie,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Starmie_gba : gMonIcon_Starmie,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, 7, SHADOW_SIZE_L)
        FOOTPRINT(Starmie)
    ...
    [SPECIES_MR_MIME] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_MrMime_gba : gMonFrontPic_MrMime,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 8 : 6,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 15),
        ...
        .frontAnimId = ANIM_H_SLIDE_SLOW,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_MrMime_gba : gMonBackPic_MrMime,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 40) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 13 : 8,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_MrMime_gba : gMonPalette_MrMime,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_MrMime_gba : gMonShinyPalette_MrMime,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_MrMime_gba : gMonIcon_MrMime,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-1, 7, SHADOW_SIZE_M)
        FOOTPRINT(MrMime)
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .trainerScale = 293,
        .trainerOffset = 2,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Scyther_gba : gMonFrontPic_Scyther,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 64) : MON_COORDS_SIZE(56, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 0 : 1,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 5),
            ANIMCMD_FRAME(0, 5),
        ...
        .frontAnimDelay = 10,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Scyther_gba : gMonBackPic_Scyther,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 7 : 3,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Scyther_gba : gMonPalette_Scyther,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Scyther_gba : gMonShinyPalette_Scyther,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Scyther_gba : gMonIcon_Scyther,
        .iconPalIndex = 1,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_SCIZOR] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Scizor_gba : gMonFrontPic_Scizor,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 0 : 2,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 20),
            ANIMCMD_FRAME(0, 20),
        ),
        .frontAnimId = ANIM_H_VIBRATE,
        .frontAnimDelay = 19,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Scizor_gba : gMonBackPic_Scizor,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 4,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Scizor_gba : gMonPalette_Scizor,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Scizor_gba : gMonShinyPalette_Scizor,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Scizor_gba : gMonIcon_Scizor,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_SMOOCHUM] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Smoochum_gba : gMonFrontPic_Smoochum,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(24, 40) : MON_COORDS_SIZE(32, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 15 : 13,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 20),
            ANIMCMD_FRAME(0, 20),
        ...
        .frontAnimId = ANIM_GROW_VIBRATE,
        .frontAnimDelay = 40,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Smoochum_gba : gMonBackPic_Smoochum,
        .backPicSize = MON_COORDS_SIZE(40, 48),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Smoochum_gba : gMonPalette_Smoochum,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Smoochum_gba : gMonShinyPalette_Smoochum,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Smoochum_gba : gMonIcon_Smoochum,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
        SHADOW(-1, 0, SHADOW_SIZE_S)
        FOOTPRINT(Smoochum)
    ...
    [SPECIES_JYNX] =
    {
        ...
        .trainerScale = 300,
        .trainerOffset = 1,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Jynx_gba : gMonFrontPic_Jynx,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 4 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 40),
        ...
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Jynx_gba : gMonBackPic_Jynx,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 48) : MON_COORDS_SIZE(56, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 3,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Jynx_gba : gMonPalette_Jynx,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Jynx_gba : gMonShinyPalette_Jynx,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Jynx_gba : gMonIcon_Jynx,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, 3, SHADOW_SIZE_L)
        FOOTPRINT(Jynx)
    ...
    [SPECIES_ELEKID] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Elekid_gba : gMonFrontPic_Elekid,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(48, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 10 : 12,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 30),
            ANIMCMD_FRAME(1, 30),
            ANIMCMD_FRAME(0, 20),
        ...
        .frontAnimId = ANIM_FLASH_YELLOW,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Elekid_gba : gMonBackPic_Elekid,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 10,
        .backAnimId = BACK_ANIM_H_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Elekid_gba : gMonPalette_Elekid,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Elekid_gba : gMonShinyPalette_Elekid,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Elekid_gba : gMonIcon_Elekid,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
        SHADOW(-1, 1, SHADOW_SIZE_M)
        FOOTPRINT(Elekid)
    ...
    [SPECIES_ELECTABUZZ] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Electabuzz_gba : gMonFrontPic_Electabuzz,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 64) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 2 : 4,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 22),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_FLASH_YELLOW : ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL_SLOW,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Electabuzz_gba : gMonBackPic_Electabuzz,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 4,
        .backAnimId = BACK_ANIM_SHAKE_FLASH_YELLOW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Electabuzz_gba : gMonPalette_Electabuzz,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Electabuzz_gba : gMonShinyPalette_Electabuzz,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Electabuzz_gba : gMonIcon_Electabuzz,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_MAGBY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Magby_gba : gMonFrontPic_Magby,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 40) : MON_COORDS_SIZE(32, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 13 : 11,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Magby_gba : gMonBackPic_Magby,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(40, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 10,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Magby_gba : gMonPalette_Magby,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Magby_gba : gMonShinyPalette_Magby,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Magby_gba : gMonIcon_Magby,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
        SHADOW(0, 2, SHADOW_SIZE_S)
        FOOTPRINT(Magby)
    ...
    [SPECIES_MAGMAR] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Magmar_gba : gMonFrontPic_Magmar,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 40),
        ...
        .frontAnimId = ANIM_H_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Magmar_gba : gMonBackPic_Magmar,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 3,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Magmar_gba : gMonPalette_Magmar,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Magmar_gba : gMonShinyPalette_Magmar,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Magmar_gba : gMonIcon_Magmar,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(3, 8, SHADOW_SIZE_L)
        FOOTPRINT(Magmar)
    ...
    [SPECIES_PINSIR] =
    {
        ...
        .trainerScale = 257,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Pinsir_gba : gMonFrontPic_Pinsir,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 4 : 5,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 11),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_GROW_VIBRATE : ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Pinsir_gba : gMonBackPic_Pinsir,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 6,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Pinsir_gba : gMonPalette_Pinsir,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Pinsir_gba : gMonShinyPalette_Pinsir,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Pinsir_gba : gMonIcon_Pinsir,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_TAUROS] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Tauros_gba : gMonFrontPic_Tauros,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 64) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 0 : 5,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 20),
            ANIMCMD_FRAME(1, 25),
        ...
        .frontAnimId = ANIM_V_SHAKE_TWICE,
        .frontAnimDelay = 10,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Tauros_gba : gMonBackPic_Tauros,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 40) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = 13,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Tauros_gba : gMonPalette_Tauros,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Tauros_gba : gMonShinyPalette_Tauros,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Tauros_gba : gMonIcon_Tauros,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(1, 7, SHADOW_SIZE_L)
        FOOTPRINT(Tauros)
    ...
    [SPECIES_MAGIKARP] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Magikarp_gba : gMonFrontPic_Magikarp,
        .frontPicSize = MON_COORDS_SIZE(48, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 6 : 4,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 8),
        ...
        .frontAnimId = ANIM_BOUNCE_ROTATE_TO_SIDES,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Magikarp_gba : gMonBackPic_Magikarp,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 6,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Magikarp_gba : gMonPalette_Magikarp,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Magikarp_gba : gMonShinyPalette_Magikarp,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Magikarp_gba : gMonIcon_Magikarp,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_GYARADOS] =
    {
        ...
        .trainerScale = 481,
        .trainerOffset = 13,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Gyarados_gba : gMonFrontPic_Gyarados,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 8 : 2,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 8),
            ANIMCMD_FRAME(1, 32),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Gyarados_gba : gMonBackPic_Gyarados,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 64) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 0 : 5,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Gyarados_gba : gMonPalette_Gyarados,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Gyarados_gba : gMonShinyPalette_Gyarados,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Gyarados_gba : gMonIcon_Gyarados,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_LAPRAS] =
    {
        ...
        .trainerScale = 423,
        .trainerOffset = 8,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Lapras_gba : gMonFrontPic_Lapras,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 40) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 13 : 2,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 30),
            ANIMCMD_FRAME(0, 10),
        ),
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Lapras_gba : gMonBackPic_Lapras,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(56, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 4 : 3,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_BLUE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Lapras_gba : gMonPalette_Lapras,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Lapras_gba : gMonShinyPalette_Lapras,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Lapras_gba : gMonIcon_Lapras,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(2, 8, SHADOW_SIZE_XL_BATTLE_ONLY)
        FOOTPRINT(Lapras)
    ...
    [SPECIES_DITTO] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Ditto_gba : gMonFrontPic_Ditto,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 32) : MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 17 : 15,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 10),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Ditto_gba : gMonBackPic_Ditto,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 32) : MON_COORDS_SIZE(48, 32),
        .backPicYOffset = 17,
        .backAnimId = BACK_ANIM_SHRINK_GROW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Ditto_gba : gMonPalette_Ditto,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Ditto_gba : gMonShinyPalette_Ditto,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Ditto_gba : gMonIcon_Ditto,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
        SHADOW(0, -4, SHADOW_SIZE_M)
        FOOTPRINT(Ditto)
    ...
    [SPECIES_EEVEE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Eevee_gba : gMonFrontPic_Eevee,
        .frontPicSize = MON_COORDS_SIZE(40, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 9 : 11,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 33),
        ...
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Eevee_gba : gMonBackPic_Eevee,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Eevee_gba : gMonPalette_Eevee,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Eevee_gba : gMonShinyPalette_Eevee,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Eevee_gba : gMonIcon_Eevee,
        .iconPalIndex = 2,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_VAPOREON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Vaporeon_gba : gMonFrontPic_Vaporeon,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 6 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 40),
            ANIMCMD_FRAME(0, 10),
        ),
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_STRETCH : ANIM_GLOW_BLUE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Vaporeon_gba : gMonBackPic_Vaporeon,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 5,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_BLUE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Vaporeon_gba : gMonPalette_Vaporeon,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Vaporeon_gba : gMonShinyPalette_Vaporeon,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Vaporeon_gba : gMonIcon_Vaporeon,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_JOLTEON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Jolteon_gba : gMonFrontPic_Jolteon,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 9 : 10,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 15),
            ANIMCMD_FRAME(0, 15),
        ),
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_SQUISH_AND_BOUNCE : ANIM_GROW_VIBRATE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Jolteon_gba : gMonBackPic_Jolteon,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(56, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 6 : 7,
        .backAnimId = BACK_ANIM_SHAKE_FLASH_YELLOW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Jolteon_gba : gMonPalette_Jolteon,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Jolteon_gba : gMonShinyPalette_Jolteon,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Jolteon_gba : gMonIcon_Jolteon,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 0 : 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, 2, SHADOW_SIZE_M)
        FOOTPRINT(Jolteon)
    ...
    [SPECIES_FLAREON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Flareon_gba : gMonFrontPic_Flareon,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 10 : 11,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 30),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_STRETCH : ANIM_V_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Flareon_gba : gMonBackPic_Flareon,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 5 : 9,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Flareon_gba : gMonPalette_Flareon,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Flareon_gba : gMonShinyPalette_Flareon,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Flareon_gba : gMonIcon_Flareon,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 0 : 3,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-2, 1, SHADOW_SIZE_L)
        FOOTPRINT(Flareon)
    ...
    [SPECIES_ESPEON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Espeon_gba : gMonFrontPic_Espeon,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(48, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 8 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 25),
            ANIMCMD_FRAME(0, 20),
        ...
        .frontAnimId = ANIM_GROW_VIBRATE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Espeon_gba : gMonBackPic_Espeon,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 8,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Espeon_gba : gMonPalette_Espeon,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Espeon_gba : gMonShinyPalette_Espeon,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Espeon_gba : gMonIcon_Espeon,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_UMBREON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Umbreon_gba : gMonFrontPic_Umbreon,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(40, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 8 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 40),
            ANIMCMD_FRAME(0, 20),
        ...
        .frontAnimId = ANIM_V_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Umbreon_gba : gMonBackPic_Umbreon,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 4 : 2,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Umbreon_gba : gMonPalette_Umbreon,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Umbreon_gba : gMonShinyPalette_Umbreon,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Umbreon_gba : gMonIcon_Umbreon,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_PORYGON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Porygon_gba : gMonFrontPic_Porygon,
        .frontPicSize = MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 13 : 14,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
        ...
        .frontAnimId = ANIM_V_JUMPS_SMALL,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Porygon_gba : gMonBackPic_Porygon,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(56, 40),
        .backPicYOffset = 13,
        .backAnimId = BACK_ANIM_H_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Porygon_gba : gMonPalette_Porygon,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Porygon_gba : gMonShinyPalette_Porygon,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Porygon_gba : gMonIcon_Porygon,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, -2, SHADOW_SIZE_S)
        FOOTPRINT(Porygon)
    ...
    [SPECIES_PORYGON2] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Porygon2_gba : gMonFrontPic_Porygon2,
        .frontPicSize = MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 0 : 9,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Porygon2_gba : gMonBackPic_Porygon2,
        .backPicSize = MON_COORDS_SIZE(56, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 11,
        .backAnimId = BACK_ANIM_H_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Porygon2_gba : gMonPalette_Porygon2,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Porygon2_gba : gMonShinyPalette_Porygon2,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Porygon2_gba : gMonIcon_Porygon2,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
    ...
    [SPECIES_OMANYTE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Omanyte_gba : gMonFrontPic_Omanyte,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 40) : MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 15 : 14,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Omanyte_gba : gMonBackPic_Omanyte,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(48, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 12,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Omanyte_gba : gMonPalette_Omanyte,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Omanyte_gba : gMonShinyPalette_Omanyte,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Omanyte_gba : gMonIcon_Omanyte,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
        SHADOW(-2, -2, SHADOW_SIZE_S)
        FOOTPRINT(Omanyte)
    ...
    [SPECIES_OMASTAR] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Omastar_gba : gMonFrontPic_Omastar,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 7 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 10),
        ...
        .frontAnimId = ANIM_GROW_VIBRATE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Omastar_gba : gMonBackPic_Omastar,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 7,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Omastar_gba : gMonPalette_Omastar,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Omastar_gba : gMonShinyPalette_Omastar,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Omastar_gba : gMonIcon_Omastar,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_KABUTO] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Kabuto_gba : gMonFrontPic_Kabuto,
        .frontPicSize = MON_COORDS_SIZE(40, 32),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 17 : 16,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 8),
            ANIMCMD_FRAME(0, 8),
            ANIMCMD_FRAME(1, 8),
        ...
        .frontAnimId = ANIM_H_SLIDE_WOBBLE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Kabuto_gba : gMonBackPic_Kabuto,
        .backPicSize = MON_COORDS_SIZE(48, 40),
        .backPicYOffset = 13,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Kabuto_gba : gMonPalette_Kabuto,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Kabuto_gba : gMonShinyPalette_Kabuto,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Kabuto_gba : gMonIcon_Kabuto,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
        SHADOW(2, -3, SHADOW_SIZE_S)
        FOOTPRINT(Kabuto)
    ...
    [SPECIES_KABUTOPS] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Kabutops_gba : gMonFrontPic_Kabutops,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 3 : 2,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
        ...
        .frontAnimId = ANIM_H_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Kabutops_gba : gMonBackPic_Kabutops,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 5 : 6,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Kabutops_gba : gMonPalette_Kabutops,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Kabutops_gba : gMonShinyPalette_Kabutops,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Kabutops_gba : gMonIcon_Kabutops,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_AERODACTYL] =
    {
        ...
        .trainerScale = 302,
        .trainerOffset = 4,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Aerodactyl_gba : gMonFrontPic_Aerodactyl,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 1 : 4,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 25),
            ANIMCMD_FRAME(1, 10),
        ...
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 7 : 9,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Aerodactyl_gba : gMonBackPic_Aerodactyl,
        .backPicSize = MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 10,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Aerodactyl_gba : gMonPalette_Aerodactyl,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Aerodactyl_gba : gMonShinyPalette_Aerodactyl,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Aerodactyl_gba : gMonIcon_Aerodactyl,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 0 : 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SNORLAX] =
    {
        ...
        .trainerScale = 423,
        .trainerOffset = 11,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Snorlax_gba : gMonFrontPic_Snorlax,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 5 : 1,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 50),
            ANIMCMD_FRAME(1, 50),
            ANIMCMD_FRAME(0, 10),
        ),
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_SWING_CONCAVE : ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Snorlax_gba : gMonBackPic_Snorlax,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 48) : MON_COORDS_SIZE(64, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 13,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Snorlax_gba : gMonPalette_Snorlax,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Snorlax_gba : gMonShinyPalette_Snorlax,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Snorlax_gba : gMonIcon_Snorlax,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 3,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_ARTICUNO] =
    {
        ...
        .trainerScale = 309,
        .trainerOffset = 2,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Articuno_gba : gMonFrontPic_Articuno,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 3 : 2,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 25),
        ...
        .frontAnimId = ANIM_GROW_VIBRATE,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 6 : 0,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Articuno_gba : gMonBackPic_Articuno,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 12 : 5,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_BLUE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Articuno_gba : gMonPalette_Articuno,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Articuno_gba : gMonShinyPalette_Articuno,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Articuno_gba : gMonIcon_Articuno,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 0 : 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_ZAPDOS] =
    {
        ...
        .trainerScale = 318,
        .trainerOffset = 3,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Zapdos_gba : gMonFrontPic_Zapdos,
        .frontPicSize = MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
        ...
        .frontAnimId = ANIM_FLASH_YELLOW,
        .enemyMonElevation = 8,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Zapdos_gba : gMonBackPic_Zapdos,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 12,
        .backAnimId = BACK_ANIM_SHAKE_FLASH_YELLOW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Zapdos_gba : gMonPalette_Zapdos,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Zapdos_gba : gMonShinyPalette_Zapdos,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Zapdos_gba : gMonIcon_Zapdos,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_MOLTRES] =
    {
        ...
        .trainerScale = 387,
        .trainerOffset = 8,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Moltres_gba : gMonFrontPic_Moltres,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 0 : 1,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 3),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 5 : 0,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Moltres_gba : gMonBackPic_Moltres,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 4 : 5,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Moltres_gba : gMonPalette_Moltres,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Moltres_gba : gMonShinyPalette_Moltres,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Moltres_gba : gMonIcon_Moltres,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-1, 12, SHADOW_SIZE_M)
        FOOTPRINT(Moltres)
    ...
    [SPECIES_DRATINI] =
    {
        ...
        .trainerScale = 386,
        .trainerOffset = 6,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Dratini_gba : gMonFrontPic_Dratini,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 40) : MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 14 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 15),
            ANIMCMD_FRAME(0, 15),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Dratini_gba : gMonBackPic_Dratini,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 8,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Dratini_gba : gMonPalette_Dratini,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Dratini_gba : gMonShinyPalette_Dratini,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Dratini_gba : gMonIcon_Dratini,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_DRAGONAIR] =
    {
        ...
        .trainerScale = 411,
        .trainerOffset = 5,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Dragonair_gba : gMonFrontPic_Dragonair,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 6 : 1,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 20),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_SHAKE : ANIM_GROW_VIBRATE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Dragonair_gba : gMonBackPic_Dragonair,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 64) : MON_COORDS_SIZE(40, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 0 : 4,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Dragonair_gba : gMonPalette_Dragonair,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Dragonair_gba : gMonShinyPalette_Dragonair,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Dragonair_gba : gMonIcon_Dragonair,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, 10, SHADOW_SIZE_XL_BATTLE_ONLY)
        FOOTPRINT(Dragonair)
    ...
    [SPECIES_DRAGONITE] =
    {
        ...
        .trainerScale = 309,
        .trainerOffset = 4,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Dragonite_gba : gMonFrontPic_Dragonite,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 50),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_SLIDE_SLOW : ANIM_V_SHAKE,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 6 : 0,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Dragonite_gba : gMonBackPic_Dragonite,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 6 : 1,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Dragonite_gba : gMonPalette_Dragonite,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Dragonite_gba : gMonShinyPalette_Dragonite,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Dragonite_gba : gMonIcon_Dragonite,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, 11, SHADOW_SIZE_XL_BATTLE_ONLY)
        FOOTPRINT(Dragonite)
    ...
    [SPECIES_MEWTWO] =
    {
        ...
        .trainerScale = 309,
        .trainerOffset = 4,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Mewtwo_gba : gMonFrontPic_Mewtwo,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 15),
        ...
        .frontAnimId = ANIM_GROW_VIBRATE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Mewtwo_gba : gMonBackPic_Mewtwo,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 64) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 1,
        .backAnimId = BACK_ANIM_GROW_STUTTER,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Mewtwo_gba : gMonPalette_Mewtwo,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Mewtwo_gba : gMonShinyPalette_Mewtwo,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Mewtwo_gba : gMonIcon_Mewtwo,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(6, 12, SHADOW_SIZE_XL_BATTLE_ONLY)
        FOOTPRINT(Mewtwo)
    ...
    [SPECIES_MEW] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Mew_gba : gMonFrontPic_Mew,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(64, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 13 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 50),
            ANIMCMD_FRAME(1, 40),
            ANIMCMD_FRAME(0, 10),
        ),
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_SWING_CONVEX : ANIM_ZIGZAG_SLOW,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 8 : 11,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Mew_gba : gMonBackPic_Mew,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 0,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Mew_gba : gMonPalette_Mew,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Mew_gba : gMonShinyPalette_Mew,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Mew_gba : gMonIcon_Mew,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
