...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Chikorita_gba : gMonFrontPic_Chikorita,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 40) : MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 13 : 10,
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Chikorita_gba : gMonBackPic_Chikorita,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 48) : MON_COORDS_SIZE(56, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Chikorita_gba : gMonPalette_Chikorita,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Chikorita_gba : gMonShinyPalette_Chikorita,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Chikorita_gba : gMonIcon_Chikorita,
        .iconPalIndex = 1,
    ...
    [SPECIES_BAYLEEF] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Bayleef_gba : gMonFrontPic_Bayleef,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(48, 64),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Bayleef_gba : gMonBackPic_Bayleef,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 5,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Bayleef_gba : gMonPalette_Bayleef,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Bayleef_gba : gMonShinyPalette_Bayleef,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Bayleef_gba : gMonIcon_Bayleef,
        .iconPalIndex = 1,
    ...
    [SPECIES_MEGANIUM] =
    {
        ...
        .trainerScale = 277,
        .trainerOffset = 1,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Meganium_gba : gMonFrontPic_Meganium,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 64) : MON_COORDS_SIZE(48, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 40),
            ANIMCMD_FRAME(0, 5),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Meganium_gba : gMonBackPic_Meganium,
        .backPicSize = MON_COORDS_SIZE(56, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 0 : 2,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Meganium_gba : gMonPalette_Meganium,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Meganium_gba : gMonShinyPalette_Meganium,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Meganium_gba : gMonIcon_Meganium,
        .iconPalIndex = 1,
    ...
    [SPECIES_CYNDAQUIL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Cyndaquil_gba : gMonFrontPic_Cyndaquil,
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_JUMPS_SMALL : ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Cyndaquil_gba : gMonBackPic_Cyndaquil,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 3,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Cyndaquil_gba : gMonPalette_Cyndaquil,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Cyndaquil_gba : gMonShinyPalette_Cyndaquil,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Cyndaquil_gba : gMonIcon_Cyndaquil,
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Quilava_gba : gMonFrontPic_Quilava,
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_STRETCH : ANIM_H_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Quilava_gba : gMonBackPic_Quilava,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 4 : 0,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Quilava_gba : gMonPalette_Quilava,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Quilava_gba : gMonShinyPalette_Quilava,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Quilava_gba : gMonIcon_Quilava,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 3,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_TYPHLOSION] =
    {
        ...
        .trainerScale = 268,
        .trainerOffset = 1,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Typhlosion_gba : gMonFrontPic_Typhlosion,
        ...
        .frontAnimDelay = 20,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Typhlosion_gba : gMonBackPic_Typhlosion,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 4 : 3,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Typhlosion_gba : gMonPalette_Typhlosion,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Typhlosion_gba : gMonShinyPalette_Typhlosion,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Typhlosion_gba : gMonIcon_Typhlosion,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 3,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_TOTODILE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Totodile_gba : gMonFrontPic_Totodile,
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Totodile_gba : gMonBackPic_Totodile,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 10,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Totodile_gba : gMonPalette_Totodile,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Totodile_gba : gMonShinyPalette_Totodile,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Totodile_gba : gMonIcon_Totodile,
    ...
    [SPECIES_CROCONAW] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Croconaw_gba : gMonFrontPic_Croconaw,
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Croconaw_gba : gMonBackPic_Croconaw,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(56, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 7 : 2,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Croconaw_gba : gMonPalette_Croconaw,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Croconaw_gba : gMonShinyPalette_Croconaw,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Croconaw_gba : gMonIcon_Croconaw,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_FERALIGATR] =
    {
        ...
        .trainerScale = 342,
        .trainerOffset = 7,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Feraligatr_gba : gMonFrontPic_Feraligatr,
        ...
        .frontAnimId = ANIM_H_SHAKE,
        .frontAnimDelay = 5,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Feraligatr_gba : gMonBackPic_Feraligatr,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 64) : MON_COORDS_SIZE(56, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 1 : 2,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Feraligatr_gba : gMonPalette_Feraligatr,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Feraligatr_gba : gMonShinyPalette_Feraligatr,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Feraligatr_gba : gMonIcon_Feraligatr,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Sentret_gba : gMonFrontPic_Sentret,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 56) : MON_COORDS_SIZE(40, 64),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Sentret_gba : gMonBackPic_Sentret,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(48, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 5 : 0,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Sentret_gba : gMonPalette_Sentret,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Sentret_gba : gMonShinyPalette_Sentret,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Sentret_gba : gMonIcon_Sentret,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_FURRET] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Furret_gba : gMonFrontPic_Furret,
        .frontPicSize = MON_COORDS_SIZE(48, 56),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Furret_gba : gMonBackPic_Furret,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 6,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Furret_gba : gMonPalette_Furret,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Furret_gba : gMonShinyPalette_Furret,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Furret_gba : gMonIcon_Furret,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Hoothoot_gba : gMonFrontPic_Hoothoot,
        .frontPicSize = MON_COORDS_SIZE(40, 40),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Hoothoot_gba : gMonBackPic_Hoothoot,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 4,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Hoothoot_gba : gMonPalette_Hoothoot,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Hoothoot_gba : gMonShinyPalette_Hoothoot,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Hoothoot_gba : gMonIcon_Hoothoot,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Noctowl_gba : gMonFrontPic_Noctowl,
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Noctowl_gba : gMonBackPic_Noctowl,
        .backPicSize = MON_COORDS_SIZE(48, 64),
        .backPicYOffset = 3,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Noctowl_gba : gMonPalette_Noctowl,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Noctowl_gba : gMonShinyPalette_Noctowl,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Noctowl_gba : gMonIcon_Noctowl,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Ledyba_gba : gMonFrontPic_Ledyba,
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Ledyba_gba : gMonBackPic_Ledyba,
        .backPicSize = MON_COORDS_SIZE(56, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 8,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Ledyba_gba : gMonPalette_Ledyba,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Ledyba_gba : gMonShinyPalette_Ledyba,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Ledyba_gba : gMonIcon_Ledyba,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Ledian_gba : gMonFrontPic_Ledian,
        .frontPicSize = MON_COORDS_SIZE(48, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 4 : 6,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 25),
            ANIMCMD_FRAME(0, 25),
            ANIMCMD_FRAME(1, 25),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_SLIDE_SLOW : ANIM_V_SLIDE_WOBBLE,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 8 : 10,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Ledian_gba : gMonBackPic_Ledian,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 7 : 3,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Ledian_gba : gMonPalette_Ledian,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Ledian_gba : gMonShinyPalette_Ledian,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Ledian_gba : gMonIcon_Ledian,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Spinarak_gba : gMonFrontPic_Spinarak,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 32) : MON_COORDS_SIZE(48, 32),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 19 : 16,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 6),
            ANIMCMD_FRAME(0, 6),
            ANIMCMD_FRAME(1, 6),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Spinarak_gba : gMonBackPic_Spinarak,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 24) : MON_COORDS_SIZE(64, 32),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 21 : 16,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Spinarak_gba : gMonPalette_Spinarak,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Spinarak_gba : gMonShinyPalette_Spinarak,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Spinarak_gba : gMonIcon_Spinarak,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Ariados_gba : gMonFrontPic_Ariados,
        ...
        .frontAnimId = ANIM_H_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Ariados_gba : gMonBackPic_Ariados,
        .backPicSize = MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 9,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Ariados_gba : gMonPalette_Ariados,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Ariados_gba : gMonShinyPalette_Ariados,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Ariados_gba : gMonIcon_Ariados,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Chinchou_gba : gMonFrontPic_Chinchou,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 40) : MON_COORDS_SIZE(64, 48),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Chinchou_gba : gMonBackPic_Chinchou,
        .backPicSize = MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 11,
        .backAnimId = BACK_ANIM_V_STRETCH,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Chinchou_gba : gMonPalette_Chinchou,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Chinchou_gba : gMonShinyPalette_Chinchou,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Chinchou_gba : gMonIcon_Chinchou,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_LANTURN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Lanturn_gba : gMonFrontPic_Lanturn,
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Lanturn_gba : gMonBackPic_Lanturn,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 6,
        .backAnimId = BACK_ANIM_SHAKE_FLASH_YELLOW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Lanturn_gba : gMonPalette_Lanturn,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Lanturn_gba : gMonShinyPalette_Lanturn,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Lanturn_gba : gMonIcon_Lanturn,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Togepi_gba : gMonFrontPic_Togepi,
        .frontPicSize = MON_COORDS_SIZE(24, 32),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 20 : 16,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 50),
            ANIMCMD_FRAME(1, 50),
            ANIMCMD_FRAME(0, 10),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Togepi_gba : gMonBackPic_Togepi,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 32) : MON_COORDS_SIZE(48, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 16 : 12,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Togepi_gba : gMonPalette_Togepi,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Togepi_gba : gMonShinyPalette_Togepi,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Togepi_gba : gMonIcon_Togepi,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
    ...
    [SPECIES_TOGETIC] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Togetic_gba : gMonFrontPic_Togetic,
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Togetic_gba : gMonBackPic_Togetic,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 6,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Togetic_gba : gMonPalette_Togetic,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Togetic_gba : gMonShinyPalette_Togetic,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Togetic_gba : gMonIcon_Togetic,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_NATU] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Natu_gba : gMonFrontPic_Natu,
        .frontPicSize = MON_COORDS_SIZE(32, 32),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 20 : 17,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 20),
            ANIMCMD_FRAME(0, 15),
        ...
        .frontAnimId = ANIM_H_JUMPS,
        .frontAnimDelay = 30,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Natu_gba : gMonBackPic_Natu,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 32) : MON_COORDS_SIZE(40, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 17 : 15,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Natu_gba : gMonPalette_Natu,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Natu_gba : gMonShinyPalette_Natu,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Natu_gba : gMonIcon_Natu,
    ...
    [SPECIES_XATU] =
    {
        ...
        .trainerScale = 318,
        .trainerOffset = 4,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Xatu_gba : gMonFrontPic_Xatu,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 56) : MON_COORDS_SIZE(40, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 7 : 5,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 45),
            ANIMCMD_FRAME(0, 15),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Xatu_gba : gMonBackPic_Xatu,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 6,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Xatu_gba : gMonPalette_Xatu,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Xatu_gba : gMonShinyPalette_Xatu,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Xatu_gba : gMonIcon_Xatu,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 0 : 1,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Mareep_gba : gMonFrontPic_Mareep,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(40, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 16 : 12,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .frontAnimDelay = 50,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Mareep_gba : gMonBackPic_Mareep,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 15,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Mareep_gba : gMonPalette_Mareep,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Mareep_gba : gMonShinyPalette_Mareep,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Mareep_gba : gMonIcon_Mareep,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
        SHADOW(1, 1, SHADOW_SIZE_M)
        FOOTPRINT(Mareep)
    ...
    [SPECIES_FLAAFFY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Flaaffy_gba : gMonFrontPic_Flaaffy,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 48) : MON_COORDS_SIZE(48, 48),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_JUMPS_BIG : ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Flaaffy_gba : gMonBackPic_Flaaffy,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(48, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 7,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Flaaffy_gba : gMonPalette_Flaaffy,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Flaaffy_gba : gMonShinyPalette_Flaaffy,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Flaaffy_gba : gMonIcon_Flaaffy,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Ampharos_gba : gMonFrontPic_Ampharos,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(56, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 5 : 2,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 50),
            ANIMCMD_FRAME(1, 15),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimDelay = 10,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Ampharos_gba : gMonBackPic_Ampharos,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 64) : MON_COORDS_SIZE(56, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 1 : 3,
        .backAnimId = BACK_ANIM_SHAKE_FLASH_YELLOW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Ampharos_gba : gMonPalette_Ampharos,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Ampharos_gba : gMonShinyPalette_Ampharos,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Ampharos_gba : gMonIcon_Ampharos,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_AZURILL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Azurill_gba : gMonFrontPic_Azurill,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 15 : 11,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 12),
            ANIMCMD_FRAME(1, 12),
            ANIMCMD_FRAME(0, 12),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Azurill_gba : gMonBackPic_Azurill,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 6,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Azurill_gba : gMonPalette_Azurill,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Azurill_gba : gMonShinyPalette_Azurill,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Azurill_gba : gMonIcon_Azurill,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
    ...
    [SPECIES_MARILL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Marill_gba : gMonFrontPic_Marill,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(56, 40),
        .frontPicYOffset = 14,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 30),
            ANIMCMD_FRAME(1, 30),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Marill_gba : gMonBackPic_Marill,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 40) : MON_COORDS_SIZE(64, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 12 : 13,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Marill_gba : gMonPalette_Marill,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Marill_gba : gMonShinyPalette_Marill,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Marill_gba : gMonIcon_Marill,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
        SHADOW(-2, 0, SHADOW_SIZE_S)
        FOOTPRINT(Marill)
    ...
    [SPECIES_AZUMARILL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Azumarill_gba : gMonFrontPic_Azumarill,
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL_SLOW : ANIM_SHRINK_GROW,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Azumarill_gba : gMonBackPic_Azumarill,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 48) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 3,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Azumarill_gba : gMonPalette_Azumarill,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Azumarill_gba : gMonShinyPalette_Azumarill,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Azumarill_gba : gMonIcon_Azumarill,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SUDOWOODO] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Sudowoodo_gba : gMonFrontPic_Sudowoodo,
        .frontPicSize = MON_COORDS_SIZE(48, 56),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Sudowoodo_gba : gMonBackPic_Sudowoodo,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(48, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 5,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Sudowoodo_gba : gMonPalette_Sudowoodo,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Sudowoodo_gba : gMonShinyPalette_Sudowoodo,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Sudowoodo_gba : gMonIcon_Sudowoodo,
        .iconPalIndex = 1,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Hoppip_gba : gMonFrontPic_Hoppip,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 10 : 14,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 25),
            ANIMCMD_FRAME(0, 25),
            ANIMCMD_FRAME(1, 25),
        ...
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 11 : 15,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Hoppip_gba : gMonBackPic_Hoppip,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 11 : 8,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Hoppip_gba : gMonPalette_Hoppip,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Hoppip_gba : gMonShinyPalette_Hoppip,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Hoppip_gba : gMonIcon_Hoppip,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SKIPLOOM] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Skiploom_gba : gMonFrontPic_Skiploom,
        .frontPicSize = MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 12),
        ...
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 12 : 15,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Skiploom_gba : gMonBackPic_Skiploom,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 13 : 4,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Skiploom_gba : gMonPalette_Skiploom,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Skiploom_gba : gMonShinyPalette_Skiploom,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Skiploom_gba : gMonIcon_Skiploom,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_JUMPLUFF] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Jumpluff_gba : gMonFrontPic_Jumpluff,
        ...
        .frontAnimId = ANIM_V_SLIDE_WOBBLE_SMALL,
        .enemyMonElevation = 9,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Jumpluff_gba : gMonBackPic_Jumpluff,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(56, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 4 : 3,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Jumpluff_gba : gMonPalette_Jumpluff,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Jumpluff_gba : gMonShinyPalette_Jumpluff,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Jumpluff_gba : gMonIcon_Jumpluff,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_AIPOM] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Aipom_gba : gMonFrontPic_Aipom,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 64) : MON_COORDS_SIZE(32, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 3 : 1,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 35),
            ANIMCMD_FRAME(0, 5),
        ),
        .frontAnimId = ANIM_H_JUMPS_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Aipom_gba : gMonBackPic_Aipom,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 3,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Aipom_gba : gMonPalette_Aipom,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Aipom_gba : gMonShinyPalette_Aipom,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Aipom_gba : gMonIcon_Aipom,
        .iconPalIndex = 2,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_SUNKERN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Sunkern_gba : gMonFrontPic_Sunkern,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 32) : MON_COORDS_SIZE(32, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 16 : 17,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 8),
            ANIMCMD_FRAME(0, 8),
            ANIMCMD_FRAME(1, 8),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_JUMPS_SMALL : ANIM_H_JUMPS,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Sunkern_gba : gMonBackPic_Sunkern,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 48) : MON_COORDS_SIZE(48, 48),
        .backPicYOffset = 10,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Sunkern_gba : gMonPalette_Sunkern,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Sunkern_gba : gMonShinyPalette_Sunkern,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Sunkern_gba : gMonIcon_Sunkern,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
    ...
    [SPECIES_SUNFLORA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Sunflora_gba : gMonFrontPic_Sunflora,
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Sunflora_gba : gMonBackPic_Sunflora,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 7,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Sunflora_gba : gMonPalette_Sunflora,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Sunflora_gba : gMonShinyPalette_Sunflora,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Sunflora_gba : gMonIcon_Sunflora,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_YANMA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Yanma_gba : gMonFrontPic_Yanma,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 48) : MON_COORDS_SIZE(64, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 10 : 14,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 2),
            ANIMCMD_FRAME(0, 2),
        ...
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 8 : 13,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Yanma_gba : gMonBackPic_Yanma,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 4 : 0,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Yanma_gba : gMonPalette_Yanma,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Yanma_gba : gMonShinyPalette_Yanma,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Yanma_gba : gMonIcon_Yanma,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-2, 10, SHADOW_SIZE_S)
        FOOTPRINT(Yanma)
    ...
    [SPECIES_WOOPER] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Wooper_gba : gMonFrontPic_Wooper,
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Wooper_gba : gMonBackPic_Wooper,
        .backPicSize = MON_COORDS_SIZE(64, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 15 : 12,
        .backAnimId = BACK_ANIM_V_STRETCH,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Wooper_gba : gMonPalette_Wooper,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Wooper_gba : gMonShinyPalette_Wooper,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Wooper_gba : gMonIcon_Wooper,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_QUAGSIRE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Quagsire_gba : gMonFrontPic_Quagsire,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 7 : 5,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 32),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Quagsire_gba : gMonBackPic_Quagsire,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 5,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Quagsire_gba : gMonPalette_Quagsire,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Quagsire_gba : gMonShinyPalette_Quagsire,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Quagsire_gba : gMonIcon_Quagsire,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_MURKROW] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 1,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Murkrow_gba : gMonFrontPic_Murkrow,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(48, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 11 : 15,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 15),
            ANIMCMD_FRAME(0, 20),
        ),
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 0 : 12,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Murkrow_gba : gMonBackPic_Murkrow,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(40, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 10,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Murkrow_gba : gMonPalette_Murkrow,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Murkrow_gba : gMonShinyPalette_Murkrow,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Murkrow_gba : gMonIcon_Murkrow,
        .iconPalIndex = 2,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Misdreavus_gba : gMonFrontPic_Misdreavus,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 12 : 13,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 10),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Misdreavus_gba : gMonBackPic_Misdreavus,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 9,
        .backAnimId = BACK_ANIM_H_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Misdreavus_gba : gMonPalette_Misdreavus,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Misdreavus_gba : gMonShinyPalette_Misdreavus,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Misdreavus_gba : gMonIcon_Misdreavus,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_WYNAUT] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Wynaut_gba : gMonFrontPic_Wynaut,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(48, 40),
        .frontPicYOffset = 12,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
        ...
        .frontAnimId = ANIM_H_JUMPS_V_STRETCH,
        .frontAnimDelay = 15,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Wynaut_gba : gMonBackPic_Wynaut,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(48, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 7 : 11,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Wynaut_gba : gMonPalette_Wynaut,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Wynaut_gba : gMonShinyPalette_Wynaut,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Wynaut_gba : gMonIcon_Wynaut,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
        SHADOW(-1, 2, SHADOW_SIZE_S)
        FOOTPRINT(Wynaut)
    ...
    [SPECIES_WOBBUFFET] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Wobbuffet_gba : gMonFrontPic_Wobbuffet,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 6 : 5,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_DEEP_V_SQUISH_AND_BOUNCE : ANIM_GROW_VIBRATE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Wobbuffet_gba : gMonBackPic_Wobbuffet,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 40) : MON_COORDS_SIZE(56, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 12 : 10,
        .backAnimId = BACK_ANIM_V_STRETCH,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Wobbuffet_gba : gMonPalette_Wobbuffet,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Wobbuffet_gba : gMonShinyPalette_Wobbuffet,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Wobbuffet_gba : gMonIcon_Wobbuffet,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Girafarig_gba : gMonFrontPic_Girafarig,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 64) : MON_COORDS_SIZE(56, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 3 : 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 30),
            ANIMCMD_FRAME(1, 30),
            ANIMCMD_FRAME(0, 30),
        ),
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_JUMPS_BIG : ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Girafarig_gba : gMonBackPic_Girafarig,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 5 : 1,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Girafarig_gba : gMonPalette_Girafarig,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Girafarig_gba : gMonShinyPalette_Girafarig,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Girafarig_gba : gMonIcon_Girafarig,
        .iconPalIndex = 1,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_PINECO] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Pineco_gba : gMonFrontPic_Pineco,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 48) : MON_COORDS_SIZE(40, 40),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Pineco_gba : gMonBackPic_Pineco,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(56, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 15 : 13,
        .backAnimId = BACK_ANIM_H_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Pineco_gba : gMonPalette_Pineco,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Pineco_gba : gMonShinyPalette_Pineco,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Pineco_gba : gMonIcon_Pineco,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
        SHADOW(0, 2, SHADOW_SIZE_S)
        FOOTPRINT(Pineco)
    ...
    [SPECIES_FORRETRESS] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Forretress_gba : gMonFrontPic_Forretress,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 9 : 8,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
        ...
        .frontAnimId = ANIM_V_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Forretress_gba : gMonBackPic_Forretress,
        .backPicSize = MON_COORDS_SIZE(64, 32),
        .backPicYOffset = 16,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Forretress_gba : gMonPalette_Forretress,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Forretress_gba : gMonShinyPalette_Forretress,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Forretress_gba : gMonIcon_Forretress,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Dunsparce_gba : gMonFrontPic_Dunsparce,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 32) : MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 17 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 15),
            ANIMCMD_FRAME(1, 15),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .frontAnimDelay = 10,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Dunsparce_gba : gMonBackPic_Dunsparce,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 40) : MON_COORDS_SIZE(56, 32),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 15 : 17,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Dunsparce_gba : gMonPalette_Dunsparce,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Dunsparce_gba : gMonShinyPalette_Dunsparce,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Dunsparce_gba : gMonIcon_Dunsparce,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Gligar_gba : gMonFrontPic_Gligar,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 64) : MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 3 : 4,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 17),
            ANIMCMD_FRAME(0, 10),
        ),
        .frontAnimId = ANIM_SHRINK_GROW,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 6 : 8,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Gligar_gba : gMonBackPic_Gligar,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 5 : 2,
        .backAnimId = BACK_ANIM_SHRINK_GROW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Gligar_gba : gMonPalette_Gligar,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Gligar_gba : gMonShinyPalette_Gligar,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Gligar_gba : gMonIcon_Gligar,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_SNUBBULL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Snubbull_gba : gMonFrontPic_Snubbull,
        .frontPicSize = MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 13 : 12,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 32),
        ...
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Snubbull_gba : gMonBackPic_Snubbull,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(56, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 12,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Snubbull_gba : gMonPalette_Snubbull,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Snubbull_gba : gMonShinyPalette_Snubbull,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Snubbull_gba : gMonIcon_Snubbull,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
    ...
    [SPECIES_GRANBULL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Granbull_gba : gMonFrontPic_Granbull,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 56) : MON_COORDS_SIZE(56, 56),
        ...
        .frontAnimId = ANIM_V_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Granbull_gba : gMonBackPic_Granbull,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(56, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 5 : 8,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Granbull_gba : gMonPalette_Granbull,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Granbull_gba : gMonShinyPalette_Granbull,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Granbull_gba : gMonIcon_Granbull,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Qwilfish_gba : gMonFrontPic_Qwilfish,
        .frontPicSize = MON_COORDS_SIZE(40, 48),
        ...
        .frontAnimDelay = 39,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Qwilfish_gba : gMonBackPic_Qwilfish,
        .backPicSize = MON_COORDS_SIZE(56, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 7 : 6,
        .backAnimId = BACK_ANIM_GROW_STUTTER,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Qwilfish_gba : gMonPalette_Qwilfish,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Qwilfish_gba : gMonShinyPalette_Qwilfish,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Qwilfish_gba : gMonIcon_Qwilfish,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SHUCKLE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Shuckle_gba : gMonFrontPic_Shuckle,
        ...
        .frontAnimId = ANIM_SWING_CONCAVE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Shuckle_gba : gMonBackPic_Shuckle,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 48) : MON_COORDS_SIZE(48, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Shuckle_gba : gMonPalette_Shuckle,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Shuckle_gba : gMonShinyPalette_Shuckle,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Shuckle_gba : gMonIcon_Shuckle,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Heracross_gba : gMonFrontPic_Heracross,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 3 : 1,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Heracross_gba : gMonBackPic_Heracross,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(48, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 4 : 2,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Heracross_gba : gMonPalette_Heracross,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Heracross_gba : gMonShinyPalette_Heracross,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Heracross_gba : gMonIcon_Heracross,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 2 : 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Sneasel_gba : gMonFrontPic_Sneasel,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 5 : 8,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 8),
            ANIMCMD_FRAME(0, 8),
            ANIMCMD_FRAME(1, 8),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_H_STRETCH : ANIM_H_JUMPS,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Sneasel_gba : gMonBackPic_Sneasel,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 3,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Sneasel_gba : gMonPalette_Sneasel,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Sneasel_gba : gMonShinyPalette_Sneasel,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Sneasel_gba : gMonIcon_Sneasel,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_TEDDIURSA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Teddiursa_gba : gMonFrontPic_Teddiursa,
        ...
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Teddiursa_gba : gMonBackPic_Teddiursa,
        .backPicSize = MON_COORDS_SIZE(48, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 10,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Teddiursa_gba : gMonPalette_Teddiursa,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Teddiursa_gba : gMonShinyPalette_Teddiursa,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Teddiursa_gba : gMonIcon_Teddiursa,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
    ...
    [SPECIES_URSARING] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Ursaring_gba : gMonFrontPic_Ursaring,
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_SHAKE : ANIM_H_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Ursaring_gba : gMonBackPic_Ursaring,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 64) : MON_COORDS_SIZE(56, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 3 : 2,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Ursaring_gba : gMonPalette_Ursaring,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Ursaring_gba : gMonShinyPalette_Ursaring,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Ursaring_gba : gMonIcon_Ursaring,
        .iconPalIndex = 2,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Slugma_gba : gMonFrontPic_Slugma,
        ...
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Slugma_gba : gMonBackPic_Slugma,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 6,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Slugma_gba : gMonPalette_Slugma,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Slugma_gba : gMonShinyPalette_Slugma,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Slugma_gba : gMonIcon_Slugma,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
    ...
    [SPECIES_MAGCARGO] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Magcargo_gba : gMonFrontPic_Magcargo,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 56) : MON_COORDS_SIZE(56, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 13 : 6,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 10),
            ANIMCMD_FRAME(0, 10),
        ...
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Magcargo_gba : gMonBackPic_Magcargo,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 9 : 7,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Magcargo_gba : gMonPalette_Magcargo,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Magcargo_gba : gMonShinyPalette_Magcargo,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Magcargo_gba : gMonIcon_Magcargo,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Swinub_gba : gMonFrontPic_Swinub,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(32, 24) : MON_COORDS_SIZE(40, 32),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Swinub_gba : gMonBackPic_Swinub,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 24) : MON_COORDS_SIZE(56, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 21 : 15,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Swinub_gba : gMonPalette_Swinub,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Swinub_gba : gMonShinyPalette_Swinub,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Swinub_gba : gMonIcon_Swinub,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
    ...
    [SPECIES_PILOSWINE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Piloswine_gba : gMonFrontPic_Piloswine,
        ...
        .frontAnimId = ANIM_H_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Piloswine_gba : gMonBackPic_Piloswine,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 40) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 13 : 8,
        .backAnimId = BACK_ANIM_H_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Piloswine_gba : gMonPalette_Piloswine,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Piloswine_gba : gMonShinyPalette_Piloswine,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Piloswine_gba : gMonIcon_Piloswine,
        .iconPalIndex = 2,
#if P_GENDER_DIFFERENCES
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Corsola_gba : gMonFrontPic_Corsola,
        .frontPicSize = MON_COORDS_SIZE(48, 40),
        .frontPicYOffset = 12,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 11),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Corsola_gba : gMonBackPic_Corsola,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(56, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 12 : 8,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Corsola_gba : gMonPalette_Corsola,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Corsola_gba : gMonShinyPalette_Corsola,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Corsola_gba : gMonIcon_Corsola,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_REMORAID] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Remoraid_gba : gMonFrontPic_Remoraid,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(40, 48),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_JUMPS_SMALL : ANIM_V_SQUISH_AND_BOUNCE_SLOW,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Remoraid_gba : gMonBackPic_Remoraid,
        .backPicSize = MON_COORDS_SIZE(56, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 13 : 12,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Remoraid_gba : gMonPalette_Remoraid,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Remoraid_gba : gMonShinyPalette_Remoraid,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Remoraid_gba : gMonIcon_Remoraid,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Octillery_gba : gMonFrontPic_Octillery,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 10 : 8,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
        ...
        .frontAnimId = ANIM_V_STRETCH,
        .frontAnimDelay = 20,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Octillery_gba : gMonBackPic_Octillery,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 8,
        .backAnimId = BACK_ANIM_SHRINK_GROW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Octillery_gba : gMonPalette_Octillery,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Octillery_gba : gMonShinyPalette_Octillery,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Octillery_gba : gMonIcon_Octillery,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Delibird_gba : gMonFrontPic_Delibird,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 48) : MON_COORDS_SIZE(48, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 8 : 7,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 15),
            ANIMCMD_FRAME(0, 15),
        ),
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_JUMPS_SMALL : ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Delibird_gba : gMonBackPic_Delibird,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 56) : MON_COORDS_SIZE(56, 56),
        .backPicYOffset = 6,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Delibird_gba : gMonPalette_Delibird,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Delibird_gba : gMonShinyPalette_Delibird,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Delibird_gba : gMonIcon_Delibird,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 0 : 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_MANTINE] =
    {
        ...
        .trainerScale = 342,
        .trainerOffset = 7,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Mantine_gba : gMonFrontPic_Mantine,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 64) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 1 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 30),
            ANIMCMD_FRAME(0, 30),
            ANIMCMD_FRAME(1, 30),
        ...
        .frontAnimId = ANIM_SWING_CONVEX,
        .enemyMonElevation = FLAG_SILLY_SCOPE ? 0 : 6,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Mantine_gba : gMonBackPic_Mantine,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 7 : 2,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Mantine_gba : gMonPalette_Mantine,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Mantine_gba : gMonShinyPalette_Mantine,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Mantine_gba : gMonIcon_Mantine,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SKARMORY] =
    {
        ...
        .trainerScale = 271,
        .trainerOffset = 1,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Skarmory_gba : gMonFrontPic_Skarmory,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 0 : 1,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 40),
        ...
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Skarmory_gba : gMonBackPic_Skarmory,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(48, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 4 : 1,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Skarmory_gba : gMonPalette_Skarmory,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Skarmory_gba : gMonShinyPalette_Skarmory,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Skarmory_gba : gMonIcon_Skarmory,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_HOUNDOUR] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Houndour_gba : gMonFrontPic_Houndour,
        .frontPicSize = MON_COORDS_SIZE(40, 48),
        ...
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Houndour_gba : gMonBackPic_Houndour,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(40, 40) : MON_COORDS_SIZE(40, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 12 : 10,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Houndour_gba : gMonPalette_Houndour,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Houndour_gba : gMonShinyPalette_Houndour,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Houndour_gba : gMonIcon_Houndour,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
        SHADOW(0, 4, SHADOW_SIZE_M)
        FOOTPRINT(Houndour)
    ...
    [SPECIES_HOUNDOOM] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Houndoom_gba : gMonFrontPic_Houndoom,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 5 : 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 40),
            ANIMCMD_FRAME(0, 30),
        ),
        .frontAnimId = ANIM_V_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Houndoom_gba : gMonBackPic_Houndoom,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 7 : 6,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Houndoom_gba : gMonPalette_Houndoom,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Houndoom_gba : gMonShinyPalette_Houndoom,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Houndoom_gba : gMonIcon_Houndoom,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Phanpy_gba : gMonFrontPic_Phanpy,
        .frontPicSize = MON_COORDS_SIZE(40, 32),
        .frontPicYOffset = 16,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 15),
        ...
        .frontAnimId = ANIM_H_JUMPS_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Phanpy_gba : gMonBackPic_Phanpy,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(56, 40),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 14 : 12,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Phanpy_gba : gMonPalette_Phanpy,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Phanpy_gba : gMonShinyPalette_Phanpy,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Phanpy_gba : gMonIcon_Phanpy,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Donphan_gba : gMonFrontPic_Donphan,
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_SHAKE_TWICE : ANIM_ROTATE_UP_SLAM_DOWN,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Donphan_gba : gMonBackPic_Donphan,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 40) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 13 : 9,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Donphan_gba : gMonPalette_Donphan,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Donphan_gba : gMonShinyPalette_Donphan,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Donphan_gba : gMonIcon_Donphan,
        .iconPalIndex = 0,
#if P_GENDER_DIFFERENCES
    ...
    [SPECIES_STANTLER] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Stantler_gba : gMonFrontPic_Stantler,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 64) : MON_COORDS_SIZE(48, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 15),
        ...
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Stantler_gba : gMonBackPic_Stantler,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 64) : MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 3 : 1,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Stantler_gba : gMonPalette_Stantler,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Stantler_gba : gMonShinyPalette_Stantler,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Stantler_gba : gMonIcon_Stantler,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SMEARGLE] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Smeargle_gba : gMonFrontPic_Smeargle,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = 6,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 12),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_H_JUMPS : ANIM_H_JUMPS_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Smeargle_gba : gMonBackPic_Smeargle,
        .backPicSize = MON_COORDS_SIZE(56, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 9,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Smeargle_gba : gMonPalette_Smeargle,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Smeargle_gba : gMonShinyPalette_Smeargle,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Smeargle_gba : gMonIcon_Smeargle,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_MILTANK] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Miltank_gba : gMonFrontPic_Miltank,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(56, 56) : MON_COORDS_SIZE(64, 48),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 4 : 8,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 30),
            ANIMCMD_FRAME(0, 30),
        ),
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Miltank_gba : gMonBackPic_Miltank,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 7 : 6,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Miltank_gba : gMonPalette_Miltank,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Miltank_gba : gMonShinyPalette_Miltank,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Miltank_gba : gMonIcon_Miltank,
    ...
    [SPECIES_RAIKOU] =
    {
        ...
        .trainerScale = 345,
        .trainerOffset = 7,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Raikou_gba : gMonFrontPic_Raikou,
        .frontPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 64) : MON_COORDS_SIZE(64, 56),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_FLASH_YELLOW : ANIM_V_STRETCH,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Raikou_gba : gMonBackPic_Raikou,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 48) : MON_COORDS_SIZE(64, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 10 : 6,
        .backAnimId = BACK_ANIM_SHAKE_FLASH_YELLOW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Raikou_gba : gMonPalette_Raikou,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Raikou_gba : gMonShinyPalette_Raikou,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Raikou_gba : gMonIcon_Raikou,
    ...
    [SPECIES_ENTEI] =
    {
        ...
        .trainerScale = 345,
        .trainerOffset = 7,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Entei_gba : gMonFrontPic_Entei,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        ...
        .frontAnimId = ANIM_GROW_VIBRATE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Entei_gba : gMonBackPic_Entei,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(64, 56) : MON_COORDS_SIZE(64, 48),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 6 : 11,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Entei_gba : gMonPalette_Entei,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Entei_gba : gMonShinyPalette_Entei,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Entei_gba : gMonIcon_Entei,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_SUICUNE] =
    {
        ...
        .trainerScale = 345,
        .trainerOffset = 7,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Suicune_gba : gMonFrontPic_Suicune,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = FLAG_SILLY_SCOPE ? 0 : 3,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 40),
            ANIMCMD_FRAME(0, 20),
        ),
        .frontAnimId = ANIM_V_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Suicune_gba : gMonBackPic_Suicune,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 3,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_BLUE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Suicune_gba : gMonPalette_Suicune,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Suicune_gba : gMonShinyPalette_Suicune,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Suicune_gba : gMonIcon_Suicune,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 0 : 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Larvitar_gba : gMonFrontPic_Larvitar,
        ...
        .frontAnimId = ANIM_V_JUMPS_SMALL,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Larvitar_gba : gMonBackPic_Larvitar,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(56, 64),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Larvitar_gba : gMonPalette_Larvitar,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Larvitar_gba : gMonShinyPalette_Larvitar,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Larvitar_gba : gMonIcon_Larvitar,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_FAST,
        SHADOW(0, 3, SHADOW_SIZE_S)
        FOOTPRINT(Larvitar)
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Pupitar_gba : gMonFrontPic_Pupitar,
        .frontPicSize = MON_COORDS_SIZE(40, 48),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_V_SHAKE : ANIM_H_SHAKE,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Pupitar_gba : gMonBackPic_Pupitar,
        .backPicSize = MON_COORDS_SIZE(48, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 5 : 9,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Pupitar_gba : gMonPalette_Pupitar,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Pupitar_gba : gMonShinyPalette_Pupitar,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Pupitar_gba : gMonIcon_Pupitar,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 0 : 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_TYRANITAR] =
    {
        ...
        .trainerScale = 345,
        .trainerOffset = 7,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Tyranitar_gba : gMonFrontPic_Tyranitar,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 50),
        ...
        .frontAnimDelay = 10,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Tyranitar_gba : gMonBackPic_Tyranitar,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 0 : 1,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Tyranitar_gba : gMonPalette_Tyranitar,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Tyranitar_gba : gMonShinyPalette_Tyranitar,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Tyranitar_gba : gMonIcon_Tyranitar,
    ...
    [SPECIES_LUGIA] =
    {
        ...
        .trainerScale = 721,
        .trainerOffset = 19,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Lugia_gba : gMonFrontPic_Lugia,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 5),
        ...
        .frontAnimDelay = 20,
        .enemyMonElevation = 6,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Lugia_gba : gMonBackPic_Lugia,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 1 : 0,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_BLUE,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Lugia_gba : gMonPalette_Lugia,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Lugia_gba : gMonShinyPalette_Lugia,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Lugia_gba : gMonIcon_Lugia,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_HO_OH] =
    {
        ...
        .trainerScale = 610,
        .trainerOffset = 17,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_HoOh_gba : gMonFrontPic_HoOh,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 20),
        ...
        .frontAnimId = ANIM_GROW_VIBRATE,
        .enemyMonElevation = 6,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_HoOh_gba : gMonBackPic_HoOh,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 1 : 2,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_HoOh_gba : gMonPalette_HoOh,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_HoOh_gba : gMonShinyPalette_HoOh,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_HoOh_gba : gMonIcon_HoOh,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
    ...
    [SPECIES_CELEBI] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = FLAG_SILLY_SCOPE ? gMonFrontPic_Celebi_gba : gMonFrontPic_Celebi,
        .frontPicSize = MON_COORDS_SIZE(40, 40),
        ...
        .frontAnimId = FLAG_SILLY_SCOPE ? ANIM_RISING_WOBBLE : ANIM_H_SLIDE_WOBBLE,
        .enemyMonElevation = 15,
        .backPic = FLAG_SILLY_SCOPE ? gMonBackPic_Celebi_gba : gMonBackPic_Celebi,
        .backPicSize = FLAG_SILLY_SCOPE ? MON_COORDS_SIZE(48, 48) : MON_COORDS_SIZE(48, 56),
        .backPicYOffset = FLAG_SILLY_SCOPE ? 8 : 7,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_GREEN,
        .palette = FLAG_SILLY_SCOPE ? gMonPalette_Celebi_gba : gMonPalette_Celebi,
        .shinyPalette = FLAG_SILLY_SCOPE ? gMonShinyPalette_Celebi_gba : gMonShinyPalette_Celebi,
        .iconSprite = FLAG_SILLY_SCOPE ? gMonIcon_Celebi_gba : gMonIcon_Celebi,
        .iconPalIndex = 1,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
